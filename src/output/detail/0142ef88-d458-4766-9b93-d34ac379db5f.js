export default {
  ...
  "information": {
    "name": "SECM",
    "description": "SECM is an application used for specification of truck and bus chassis.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "24bad844-5bff-4e96-9202-fe07d64a33a6",
        ...
        "displayName": "OAS Platform / OAS_OAS_production_ecm_findconditionobjects_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "a4991c8f-16dc-4386-88aa-2f42daf428df",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_exit_complemented_fpc_v2 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "dfea3c94-ecba-426f-8bd8-e987368ec001",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_vspecification_v2 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
