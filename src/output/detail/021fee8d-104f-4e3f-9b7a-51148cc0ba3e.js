export default {
  ...
  "information": {
    "name": "PPFD",
    "description": "Parts Price File Download",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "c3965f46-da62-4d6b-aca0-0bdaae17ab0c",
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "6c830088-3a48-4774-a48c-cb591c1f5616",
        "description": "This service allows distributors to download current or future Price files in a zip format. Pricelist are updated once in a week. The Price file has the following content:\r\n\r\nxx.zip (current price list) or xx.zip (for the next price list) with the following files:\r\nPrice file (i.e. Eu60000 for prices in EUR and customer number 60000)\r\nCommercial structure files:\r\n•\tCC (Component Code)\r\n•\tDC (Discount Code)\r\n•\tPRG (Product group)\r\n\r\nTechnical structure files:\r\nPAG (Part Group)\r\nRoles required: \r\nService user should be part of PPFD_App_Users to consume PPFD service. \r\n",
        "displayName": "PPFD_PPFDService IE V1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
