export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Adel",
      "lastName": "Fayad",
      "displayName": "Adel Fayad",
      "email": "adel.fayad@scania.com",
      "type": "RESPONSIBLE",
      "role": []
    },
    {
  ...
  "information": {
    "name": "WinCC",
    "description": "WinCC Applicaiton used at Sodertalje.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "dependencies": {
    ...
    "children": [
      {
        "id": "d83d691f-e4ee-40f2-9e1b-52949a0eecb9",
        "activeFrom": null,
        "activeUntil": null,
        "description": "SCADA platform from Siemens - middleware.\r\nCompatible with the following:\r\n- Windows 2000 SP4\r\n- Windows XP SP3\r\n- Windows Server 2003 SP1 + R2 (WinCC 6.2)\r\n- Windows Server 2003 SP2 (WinCC 6.2 SP2 + SP3)\r\n- SQL 2005 32-bit",
        "displayName": "WinCC / WinCC 6.2",
        "type": "Application",
        "lifecycle": null,
        "tags": [],
        "subscriptions": []
      ...
      {
        "id": "864a8183-c915-49fe-b8c6-c846f52468ac",
        "activeFrom": null,
        "activeUntil": null,
        "description": "SCADA platform from Siemens - middleware. \r\nCompatible with the following:\r\nSCADA platform from Siemens - middleware. \r\nCompatible with the following: \r\n- Windows XP SP3\r\n- Windows 7 SP1\r\n- Windows Server 2003 R2 SP2\r\n- Windows Server 2008 SP2\r\n- SQL 2008",
        "displayName": "WinCC / WinCC 7.0",
        "type": "Application",
        "lifecycle": null,
        "tags": [],
        "subscriptions": []
      ...
      {
        "id": "c1ff5113-25b3-409d-8c95-07a534c3e2df",
        "activeFrom": null,
        "activeUntil": null,
        "description": "SCADA platform from Siemens - middleware. \r\nCompatible with the following:\r\n- Windows 7 SP1\r\n- Windows Server 2008 R2 SP1\r\n- Windows Server 2012 R2\r\n- SQL 2012\r\n- Office 2007 SP2, 2010 and 2013",
        "displayName": "WinCC / WinCC 7.3",
        "type": "Application",
        "lifecycle": null,
        "tags": [],
        "subscriptions": []
  ...
  "initiatives": [
    {
      "id": "0d6adfc0-d852-43a8-96cd-54fdf4a781d5",
    ...
    {
      "id": "a0cc03db-8611-4a28-b29d-3b992ed44f61",
    ...
    {
      "id": "478afb5c-989b-427c-bb61-02a7be9ee9a5",
    ...
    {
      "id": "fb4d0e7c-689e-4bff-964f-c964e1404609",
