export default {
  ...
  "information": {
    "name": "Comptrans",
    "description": "Calibaration and version control of calibration data. Now only for engine management and aftertreatment management. Constant parameters per Engine type. \nOffline calibration.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "aa47831c-6813-4b4b-aa07-7e38f09a18aa",
    ...
    {
      "id": "10b6620e-8b92-4965-a085-0c310cd675c8",
