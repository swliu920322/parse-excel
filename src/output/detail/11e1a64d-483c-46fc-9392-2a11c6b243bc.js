export default {
  ...
  "information": {
    "name": "SIGNL4",
    "description": "SIGNL4 SaaS notification , see Monitoring Services Community in TEAMS \"Files - User guides - SIGNL4 User guide\" for information.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "tech": {
    "itComponents": {
      ...
      "service": [
        {
          "id": "eb1e1550-cf2f-4e87-bc9a-365e2018cc48",
          "displayName": "SIGNL4 SaaS",
          "category": "service",
          "description": null,
          "type": "ITComponent",
          "lifecycle": null,
