export default {
  ...
  "subscriptions": [
    {
      "firstName": "Mattias",
      "lastName": "Österman",
      "displayName": "Mattias Österman",
      "email": "mattias.osterman@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "SCOMM",
    "description": "Diagnostic communication \nScania COMmunication Module.\n\nSCOMM enables a Scania unique communication between Scania diagnostic tool and the vehicle individual and the extended vehicle, by using a Scania VCI or a Scania Telematic Unit (via RDP, MP). SCOMM is included in SDP3. Adjustments between general ways of communicating to the specific communication interfaces to ECUs that have Exemptions from Requirements in the Diagnostic Communication specifications. The object model for SOPS is implemented in SCOMM.\nSCOMM enables reading from product and writing to the product and diagnostic of the products.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "280cee5c-0275-4fba-a1c2-34952fc7b6b7",
    ...
    {
      "id": "78105cf7-a062-4fb1-948e-9ae5da65b670",
  ...
  "businessSupport": {
    ...
    "processes": [
      ...
      {
        "id": "5fab874e-270f-45ac-ad58-386efffab981",
        "displayName": "Product development / R&D Process / Embedded System process / 12 Rebuild",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
