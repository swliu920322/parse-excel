export default {
  ...
  "initiatives": [
    {
      "id": "1593acfe-5ef5-47ec-8d41-b63328a9f763",
    ...
    {
      "id": "f7e071ff-2f4b-4988-b9e4-7263d9eff64d",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "516d997d-0770-4423-91fd-a580f861e659",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing / T - Industrial Operations Asia / TT - Information Technology",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "TCMEA / VEIS",
    "ChinaDesign": "INFF / TTPH",
    "ChinaSourcing": "INFF",
    "ChinaPaying": "INFF",
    "ChinaImplementation": "TTPH / INFF",
    "Chinaverification": "TCMEA / TTPH / INFF",
    "ChinaOperations": "TTPH / INFF"
  }
}