export default {
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "cda5b3da-3349-4845-a371-4a29f2e69aa8",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IU - Infrastructure Services / IUA - Hosting Services / IUAL - Linux, Web & DB Platform Dev",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "IUAL",
    "ChinaDesign": "IUAL",
    "ChinaSourcing": "IUAL",
    "ChinaPaying": "TTIU",
    "ChinaImplementation": "IUAL",
    "Chinaverification": "TTIU",
