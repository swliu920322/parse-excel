export default {
  ...
  "subscriptions": [
    ...
    {
      "firstName": "Eduardo",
      "lastName": "de Paula Silva",
      "displayName": "Eduardo de Paula Silva",
      "email": "eduardo.silva@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "DELMIA CHN",
    "description": "Delmia Digital test assembly and welding verification is an application tight connected to Catia and used for digital test assembly and welding information. The interface looks the same as for Catia, but the target group for Delmia is users in production, not R&D, which is the main target group for Catia. \r\nDigital test assembly and welding verification. DPE PPR hub, DPP Path Planner and FAST Surf are included in DELMIA\r\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "dependencies": {
    "parent": [
      {
        "id": "73e9b521-9265-4a1f-a4e7-ac1574121bd1",
        "displayName": "DELMIA",
        "description": "Delmia Digital test assembly and welding verification is an application tight connected to Catia and used for digital test assembly and welding information. The interface looks the same as for Catia, but the target group for Delmia is users in production, not R&D, which is the main target group for Catia. \r\nDigital test assembly and welding verification. DPE PPR hub, DPP Path Planner and FAST Surf are included in DELMIA\r\n",
        "type": "Application",
        "tags": [
  ...
  "initiatives": [
    {
      "id": "5701c7c7-ba57-41ba-bd04-4596e1e3a1b4",
    ...
    {
      "id": "5f3762ab-382e-4c40-99a9-d3da8484d8f6",
    ...
    {
      "id": "86d61d41-7cba-4969-bbea-17fea87fc8e0",
    ...
    {
      "id": "5174ff22-e2e9-4668-b4e3-50bbe1dc2c8a",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "db65f767-4b16-468c-aa92-c69ef51b3f1a",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / VE - Global Industrial Development / VEE - Global Industrial Engineering Development",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
