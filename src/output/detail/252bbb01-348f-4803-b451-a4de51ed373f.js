export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "par.martensson@scania.com",
      "email": "par.martensson@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Daniel",
      "lastName": "Nyberg",
      "displayName": "Daniel Nyberg",
      "email": "daniel.nyberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "PackAssistant",
    "description": "Calculates the optimal packing in each transport unit.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "6203e4d7-7f48-4ca1-a86d-6a86f6f3b718",
    ...
    {
      "id": "60af77bb-802d-4dd9-82ba-59d7128193aa",
    ...
    {
      "id": "7fd37789-ae29-4438-99ac-12441d09ffaf",
    ...
    {
      "id": "ef9c86b6-5fef-41d0-b3a0-36f35a3f5e7c",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "565902d0-c6a3-4c05-b815-f48f2af2a0dc",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IN - Order to Delivery IT / INF - P&L Platforms / INFA - Smart Factory, Architecture, MP",
