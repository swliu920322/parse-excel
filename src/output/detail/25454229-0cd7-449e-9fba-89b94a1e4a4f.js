export default {
  ...
  "information": {
    "name": "Truck & Bus Bodybuilder Portal",
    "description": "Truck/Bus Bodybuilder is the main platform for communication between Scania and bodybuilders. The aim is to assist the bodybuilder’s work with Scania chassis.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "2569ddf1-3a09-4262-a410-14510918344c",
        "description": null,
        "displayName": "Truck & Bus Bodybuilder Portal_CSS",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "d387103e-fd75-417c-86ac-01655558a8ac",
        "description": null,
        "displayName": "Truck & Bus Bodybuilder Portal_Multi",
        "lifecycle": null,
        "tags": []
      },
      {
