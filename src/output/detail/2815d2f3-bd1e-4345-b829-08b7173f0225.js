export default {
  ...
  "subscriptions": [
    {
      "firstName": "Joyce",
      "lastName": "Yoshikawa",
      "displayName": "Joyce Yoshikawa",
      "email": "joyce.yoshikawa@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
      "firstName": "Håkan",
      "lastName": "Hedqvist",
      "displayName": "Håkan Hedqvist",
      "email": "hakan.hedqvist@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Christer",
      "lastName": "Borg",
      "displayName": "Christer Borg",
      "email": "christer.borg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
    ...
    },
    {
      "firstName": "Caroline",
      "lastName": "Pousette",
      "displayName": "Caroline Pousette",
      "email": "caroline.pousette@scania.com",
      "type": "OBSERVER",
      "role": []
    }
  ],
  "information": {
    "name": "SPCT China",
    "description": "Scania Production Computer Tools - A family of applications and infrastructure services used in manufacturing to configure and check vehicle electronics components. ",
    "lifecycle": {
      "asString": "plan",
      "phases": [
        {
    ...
    "productCategory": "Production Tools",
    "predecessor": [
      {
        "id": "9cedd11e-e33c-4526-8102-098770afa8d3",
        "displayName": "SIDE",
        "description": "SIDE is an abbreviation of Scania Individual Database for EOL programming. The application supports a data driven process for a customer unique parameterization of each ECU in a vehicle. The individual data programmed into ECU’s are parameters used to realize for vehicle functions and data to support after sales repair and rebuilding activities –which is defined as SOPS (Scania Onboard Product Specification).",
        "type": "Application",
        "tags": [
          "Not China affected",
          "Maturity Level 3"
  ...
  "initiatives": [
    {
      "id": "eff7c893-bb22-4281-a973-4a9f388eed3d",
    ...
    {
      "id": "161aeda6-ebd0-44c2-92a8-bd452d5e2089",
    ...
    {
      "id": "5838fd8a-aded-431f-af1a-f03c6b50e476",
    ...
    {
      "id": "213bf36e-2d51-4522-af77-0ebfa704383c",
    ...
    {
      "id": "54afb154-a66c-4908-a4df-93acde695127",
  ...
  "tech": {
    "itComponents": {
      "software": [
        ...
        {
          "id": "c4c373bf-6124-447e-a2f3-13aabea0970a",
          "displayName": "Microsoft Active Directory 2019",
          "category": "software",
          "description": "Active Directory (AD) is a Microsoft technology used to manage computers and other devices on a network. It is a primary feature of Windows Server, an operating system that runs both local and Internet-based servers.",
          "type": "ITComponent",
          "lifecycle": {
            "asString": "active",
            "phases": [
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "DETI/DTTG/MPC/MPG",
    "ChinaDesign": "DETI/DTTG/MPC/MPG",
    "ChinaSourcing": "INFX",
    "ChinaPaying": "TCE/TCT/TCH/TCM",
    "ChinaImplementation": "INFX",
    "Chinaverification": "DETI/DTTG/MPC/MPG",
    "ChinaOperations": "INFX"
  }
}