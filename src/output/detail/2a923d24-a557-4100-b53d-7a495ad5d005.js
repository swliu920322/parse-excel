export default {
  ...
  "subscriptions": [
    {
      "firstName": "Yash Surendranath",
      "lastName": "Gawai",
      "displayName": "Yash Surendranath Gawai",
      "email": "Yash.Gawai@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "joachim.dutz@scania.com",
      "email": "joachim.dutz@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "SALT",
    "description": "Software And Licence Tool. A system of web apps SALT and SALT Public, database SALT, console app SALTProc.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "chinaInfo": {
    ...
    "ChinaSourcing": "IBV",
    "ChinaPaying": "IBV",
    "ChinaImplementation": "IBV",
    "Chinaverification": "IBC",
    "ChinaOperations": "IBV"
  }
}