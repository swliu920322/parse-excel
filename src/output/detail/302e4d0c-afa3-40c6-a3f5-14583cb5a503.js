export default {
  ...
  "subscriptions": [
    {
      "firstName": "Jonas",
      "lastName": "Svedling",
      "displayName": "Jonas Svedling",
      "email": "jonas.svedling@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner",
  ...
  "information": {
    "name": "MSIIS",
    "description": "Microsoft IIS Service thet runs on Windows systems to serve requested HTML pages or files",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "072479fd-4b71-477b-83e3-b0a179baf282",
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "IUAW",
    "ChinaDesign": "IUAW",
    "ChinaSourcing": "IUAW",
    "ChinaPaying": "",
    "ChinaImplementation": "IUAW",
    "Chinaverification": "TTIU / IUAL",
