export default {
  ...
  "information": {
    "name": "SVPS",
    "description": "It is to measure the height, weight, length, width of the truck chassis.\nCurrently live in Sodertalje.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "21953a25-191e-46ca-82fa-add5fa623ee8",
    ...
    {
      "id": "d6659a0f-0908-4232-802e-28073dc4812f",
    ...
    {
      "id": "03227f9e-d33b-4010-87cd-d3de1dc20e50",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "a266dd17-71fd-4711-ba57-92140c025bf2",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / O - Logistics / OT - Outbound",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "OT",
    "ChinaDesign": "INBG/OT",
    "ChinaSourcing": "INBG",
    "ChinaPaying": "OT",
    "ChinaImplementation": "INBG",
    "Chinaverification": "INBG/OT",
    "ChinaOperations": "INBG"
  }
}