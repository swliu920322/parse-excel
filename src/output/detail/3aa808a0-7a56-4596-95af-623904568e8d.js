export default {
  ...
  "subscriptions": [
    {
      "firstName": "Yvonne",
      "lastName": "Helavirta",
      "displayName": "Yvonne Helavirta",
      "email": "yvonne.helavirta@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "Therefore/Kofax",
    "description": "System used to scan documents in production and store them to make them searchable for later. Supplier is Canon.\nKofax: SW client to view/validate  scanned data. \nTherefore: Web application to search the scanned documents",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "48e49232-4305-40ef-8d4f-45f2e353defb",
    ...
    {
      "id": "3df6c747-0bbc-42f9-9245-5b5699e9209d",
    ...
    {
      "id": "68ca2c8e-cf8a-4283-9427-3d85f0214ac3",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "bb70912a-f68d-4e4d-86eb-19875699d01e",
        "displayName": "Scania - Scania CV AB / P_HR - People &  Culture / HA - Global People Services / HAS - People Services Sweden / HASS - Service Management",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "c7836f75-b99a-485f-8eb3-086f1ae877a0",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / M - Chassis, Cab and Bus Production / MS - Chassis Assembly",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "9f352a29-7ca9-467d-8967-f17a88e019f7",
        "description": "Each Individual Component Value. Defined with a reference to Component Attribute.",
        "displayName": "Individual Vehicle and Engine Domain / Product As Individual Entity / Individual Component Value",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "DETI",
    "ChinaDesign": "INGB",
    "ChinaSourcing": "INGB",
    "ChinaPaying": "VEI",
    "ChinaImplementation": "INGB",
    "Chinaverification": "DETI",
    "ChinaOperations": ""
  }
}