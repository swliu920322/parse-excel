export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Lennart",
      "lastName": "Persson",
      "displayName": "Lennart Persson",
      "email": "lennart_a.persson@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
  ...
  "information": {
    "name": "COM",
    "description": "Common func lib for inhouse Oracle developed applications.\r\nAlso support a scheduler as well as COM/SIAM",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "60406ebc-57e0-4d4b-a7cc-edc182a2fa2b",
      "displayName": "Oceans 19 program",
      "fullName": "Oceans 19 program",
      "tags": [
      ...
      "subscriptions": [
        ...
        {
          "displayName": "Carina Ullberg",
          "email": "carina.ullberg@scania.com",
          "type": "OBSERVER"
        }
      ]
    },
    {
      "id": "46625cbc-1ff4-4317-ab96-a3581ed54552",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "77d4afad-a9b9-4794-b40e-07c5d9d5c4d2",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IN - Order to Delivery IT / INA - Logistics IT / INAE - MONA Logistics",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "288cb7ff-479b-4035-acb4-16b25d5a21c5",
        "description": "Business Application represents all kind of business related applications, independent if its traditional application package assets (such as applications for Sales order, Rental and Invoicing) or business driven service assets (such as Get me customer and invoice receiver, Get me product configuration).  This Business Application domain is related to the infrastructure domain IT Technology Assets.",
        "displayName": "IT@Scania Domain / IT Business Application Entity",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceProvide": [
      {
        "id": "574b32e5-2ed3-4338-8c13-7eb223bbe99e",
        "description": null,
        "displayName": "COM_comapp-api IE 1.0",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "3330f61d-9a6a-4c59-8fb4-3c9ea91b9eb7",
        "description": null,
        "displayName": "COM_comcm-api IE 1.0",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
