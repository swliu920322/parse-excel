export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Nicklas",
      "lastName": "Nordlöf",
      "displayName": "Nicklas Nordlöf",
      "email": "nicklas.nordlof@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
  ...
  "information": {
    "name": "RobotStudio",
    "description": "RobotStudio is ABB's simulation and offline programming software, offering a complete digital replica (digital twin) of physical assets or systems so you can see what’s going on in your production line remotely.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "dadb507b-1051-48f1-b6ca-ace4fa9ec0dc",
    ...
    {
      "id": "6dcacc9f-4b15-4371-8fd9-f9cf3db26c99",
    ...
    {
      "id": "d2040052-525c-4d9e-9e96-62e4b1536379",
    ...
    {
      "id": "87b321f3-cae5-46f5-af55-12a19499bea3",
