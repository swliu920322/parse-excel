export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "hakan.neeman@scania.com",
      "email": "hakan.neeman@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Michael",
      "lastName": "Eriksson",
      "displayName": "Michael Eriksson",
      "email": "michael.eriksson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner",
    ...
    },
    {
      "firstName": "Mats",
      "lastName": "Karlsson",
      "displayName": "Mats Karlsson",
      "email": "mats.karlsson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "lars.xx.karlsson@scania.com",
      "email": "lars.xx.karlsson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "maria.grundberg@scania.com",
      "email": "maria.grundberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
    },
    {
      "firstName": "Anders",
      "lastName": "Frid",
      "displayName": "Anders Frid",
      "email": "anders.frid@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "michael.palmgren@scania.com",
      "email": "michael.palmgren@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
  ...
  "information": {
    "name": "VPSX_PRINT",
    "description": "This VPSX component delivers (production critical) output/print jobs to production printers at Scania PRU:s and at Parts Logistics. For example MONA, SIMAS, KDEX, Finess, SAP and other business critical applications.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "cdee9e09-2f3f-44ea-ba04-15e5e0c78845",
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "72f7f8d8-96e5-4d49-83a4-c1fb039d57eb",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IB - Digital Workplace / IBC - Productivity Services / IBCG - Output",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "bdd0096c-76bd-4d51-af66-82985d6bc687",
          "displayName": "VPSX",
          "category": "software",
          "description": null,
          "type": "ITComponent",
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "IBCG",
    "ChinaDesign": "IBCG",
    "ChinaSourcing": "IBCG",
    "ChinaPaying": "IBCG",
    "ChinaImplementation": "IBCG",
