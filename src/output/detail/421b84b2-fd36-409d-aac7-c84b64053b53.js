export default {
  ...
  "information": {
    "name": "Storefront SSEA",
    "description": "Citrix StoreFront is an enterprise app store for users that aggregates and presents virtual app and desktop resources from on-premises and hybrid deployments—delivering a near-native user experience across Citrix Workspace app (formerly Citrix Receiver) on any platform.\nIT Delivery Responsible are external company Wipro",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
