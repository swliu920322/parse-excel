export default {
  ...
  "information": {
    "name": "INVENTOR",
    "description": "INVENTOR is used for mechanical construction in 3D, simulation, tool construction and exchange of construction data. ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "dependencies": {
    ...
    "children": [
      {
        "id": "be4a454f-c8a6-4707-aa62-aef19a01e07f",
        "activeFrom": null,
        "activeUntil": null,
        "description": "This is the free version used in the UK of the tool  Autodesk Inventor ",
        "displayName": "INVENTOR / DWG viewers from BodyBuilder SGB",
        "type": "Application",
        "lifecycle": null,
        "tags": [],
        "subscriptions": []
  ...
  "initiatives": [
    {
      "id": "34474965-0e12-4d18-b698-88ccbe9831a7",
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "88759df6-cbe0-46e1-adfa-69adc8081842",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IN - Order to Delivery IT / INB - INB Chassis & Cabs IT",
