export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Linda",
      "lastName": "Svensson",
      "displayName": "Linda Svensson",
      "email": "linda.x.svensson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "AviX",
    "description": "AviX is Scania´s main tool to use for process balancing, creating Element Sheets, documenting time analyses and creating Position Standards. AviX consists of three independent modules Method, Balance and FMEA. A SCANIA license contains three modules.\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "8b45c4cc-5117-4683-83d5-9861d07f2cf0",
    ...
    {
      "id": "5f2f9d1f-2b64-4353-8c10-7ef1b01a62cf",
