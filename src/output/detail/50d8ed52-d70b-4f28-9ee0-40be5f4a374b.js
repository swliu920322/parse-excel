export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Martin",
      "lastName": "Söderlund",
      "displayName": "Martin Söderlund",
      "email": "martin.soderlund@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
  ...
  "information": {
    "name": "Colibri China",
    "description": "Colibri is a global Application for measure colour grade on cabs, in China this is used in the topcoat workshop (CMB).\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "335e1879-d532-441c-93a6-cf2a210ecd90",
    ...
    {
      "id": "120f2935-a085-4994-a0ec-0a31bf1a54e9",
    ...
    {
      "id": "9d5636d6-3079-4a18-82fc-7a53a58a50d3",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "deeefc68-670e-49fa-b24e-4abe3957a92b",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / M - Chassis, Cab and Bus Production / MB - Cab Body Production / MBC - Paint shop",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "TCHP",
    "ChinaDesign": "INBB/INFI/TTPB (Hybrid Valuestream)",
    "ChinaSourcing": "INBB/TCHP",
    "ChinaPaying": "(Initial Costs - TCHP) / INBB",
    "ChinaImplementation": "TTPB/INBB",
    "Chinaverification": "TCHP/MBCT/INBB/INFI/TTPB",
