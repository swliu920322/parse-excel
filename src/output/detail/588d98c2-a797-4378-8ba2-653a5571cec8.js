export default {
  ...
  "subscriptions": [
    {
      "firstName": "Jonas",
      "lastName": "Fransson",
      "displayName": "Jonas Fransson",
      "email": "jonas.fransson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Linus",
      "lastName": "Sjövall",
      "displayName": "Linus Sjövall",
      "email": "Linus.Sjovall@scania.com",
      "type": "OBSERVER",
      "role": []
    }
  ],
  "information": {
    "name": "XCOM",
    "description": "Diagnostic test tool used by R&D to read from/write to/test ECUs",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "d35f6b11-2dda-4b34-af3d-0111edfb98d4",
        "displayName": "ECOM",
        "description": "Diagnostic test tool used by R&D to read from/write to/test powertrain ECUs",
        "type": "Application",
        "tags": [],
        "subscriptions": []
      }
  ...
  "initiatives": [
    {
      "id": "37501e3a-976c-4dba-892d-380cbce93b31",
    ...
    {
      "id": "7b283890-5de7-4af6-8a27-08f4a2da7bc6",
    ...
    {
      "id": "83b9fa52-49b3-4d69-a9f4-2982e23ef6fb",
    ...
    {
      "id": "01808430-d86b-48fb-975a-0080cea25e19",
    ...
    {
      "id": "8e80e450-fcc9-4bd9-8328-a1c5b8c3e26a",
    ...
    {
      "id": "2dbfb4fd-01ba-46f0-b34e-456cd85b6009",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "e5b10420-e679-4a25-b587-71b01c10abac",
      ...
      {
        "id": "2cc4bf7d-8046-4c6d-a6a2-4b00081c0d5b",
        "displayName": "Scania - Scania CV AB / L - Scania Latin America / LR - Research & Development LA",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "60f283d3-baf7-40ab-b904-c2ebddc1d7e2",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing / EV - Electrification Development",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "6a799919-9da4-4bba-a88a-3d3a602fe77c",
