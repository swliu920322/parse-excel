export default {
  ...
  "information": {
    ...
    "description": "LinkedIn Learning is a content library for Scania. This is a source for Scania to grow the total course catalog.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "d20c3f24-6d39-437e-8185-c4c6851749c8",
  ...
  "management": {
    "objects": [
      {
        "id": "30e1789a-ce4d-46bd-9212-aa99405ea680",
        "description": "Represents a course type that has a subject and a author. A course will normally be performed for many classes and occasions with different students enrolled.",
        "displayName": "Human Resources Domain / Competence Development Entity / Course",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "9e8410d5-9b3e-485a-b144-0aa343ea7ca3",
          "displayName": "Microsoft / LinkedIn Learning",
          "category": "software",
    ...
    "ssoProvider": "ADFS, Google, Microsoft Azure, Okta",
    "statusSSO": "supported"
  },
  "chinaInfo": {
