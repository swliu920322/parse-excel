export default {
  ...
  "subscriptions": [
    {
      "firstName": "Sofie",
      "lastName": "McInnes",
      "displayName": "Sofie McInnes",
      "email": "sofie.mcinnes@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Patrick",
      "lastName": "Molloy",
      "displayName": "Patrick Molloy",
      "email": "Patrick.Molloy@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
    ...
    {
      "firstName": "Karin",
      "lastName": "van Unen-Jansen",
      "displayName": "Karin van Unen-Jansen",
      "email": "Karin.van_Unen@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Gustaf",
      "lastName": "Wadman",
      "displayName": "Gustaf Wadman",
      "email": "gustaf.wadman@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    ...
    "predecessor": [
      {
        "id": "3a4549b5-63c1-4d70-9b79-fa32824e0508",
        "displayName": "Personec HR",
  ...
  "initiatives": [
    ...
    {
      "id": "150dd274-ba70-4e89-8bb1-dd23e4a01d77",
    ...
    {
      "id": "882b43d2-ed5f-4fd2-9b66-bba5783c67be",
    ...
    {
      "id": "91f89abf-9700-4daa-9eb2-464fb86fb45e",
    ...
    {
      "id": "a37378f4-6977-4471-b77c-757999192e99",
  ...
  "businessSupport": {
    ...
    "processes": [
      {
        "id": "9ca4b3d3-47dd-4810-8262-cde025df4044",
        "displayName": "Supporting processes / Human Resource SWE / Support HR SWE / Preparation performance",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
      ...
      {
        "id": "886f2a78-7bd8-499c-9397-038493db7157",
        "displayName": "Supporting processes / Human Resources / Competence development / Posisiton update",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
    ...
    "organisations": [
      ...
      {
        "id": "ceb92c0e-4e82-40b5-bf73-5e21323e7850",
        "displayName": "Scania - Scania CV AB / P_CO - Commercial Operations / W - Regional Office / WN - Region Northern Europe / WN - BU United Kingdom / MD - MD's Office / HR - Human Resources",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "687eb676-4c79-4695-bad3-99b3003da0cb",
        "displayName": "Scania - Scania CV AB / P_HR - People &  Culture / HC - Scania Academy",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "b65fdb13-829b-4a04-ae24-a3d542883906",
        "description": "A set of competencies, that may include more general and more specific competencies, that a Employment call for. This profile can be outside the current Person Competence Profile.",
        "displayName": "Human Resources Domain / Competence Development Entity / Employment Competence Profile",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceConsume": [
      {
        "id": "c4f10337-4370-4a84-a80f-9f1adb592b33",
        "description": "DATA FLOW FOR MYCOMPASS\n1.\tSGB wholly owned dealers and Keltruck – daily CSV file received from Dayforce payroll system at 6:30am. All other (independent) dealers maintain their own employee database on SGB400.\n2.\tSGB400 job runs at 7:30pm Monday-Friday to create CSV employee file\n3.\tGOA job runs at 8pm Monday-Friday, retrieves CSV file via FTP from SGB400, sends to MyCompass via SFTP.     \n",
        "displayName": "Dayforce SGB_MyCompass",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "060f1d10-2e37-4d43-8e66-6b7367cd4703",
        "description": null,
        "displayName": "MyCompass Interim Database (SGB400)_MyCompass (SGB)",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "23a2a3c7-8f27-4359-82b5-89ff3f12e615",
        "description": null,
        "displayName": "Scania Account Tool_SAT_interface",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "195cf873-3103-4700-b371-07a8e87e274a",
        "description": null,
        "displayName": "WAM_MyCompass - https://mycompass.scania.com",
        "lifecycle": null,
        "tags": [
          "XDS_RP"
        ]
      ...
      {
        "id": "9a7696e8-3954-460f-9b30-25a7a6e5a2d5",
        "description": null,
        "displayName": "WAM_MyCompass - https://mycompass.scania.com -  https://scania.csod.com",
        "lifecycle": null,
        "tags": [
          "XDS_SAML"
        ]
      ...
      {
        "id": "5da8804a-60e5-4b34-85d3-a29e890391b6",
        "description": null,
        "displayName": "WAM_ScaniaEmployeeApp - https://world.scania.com - urn:staffbase:de",
        "lifecycle": null,
        "tags": [
          "XDS_SAML-groups"
        ]
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "e6d2a4ea-447a-4836-97e6-350f2d0ea160",
          "displayName": "Cornerstone OnDemand Cornerstone",
          "category": "software",
          "description": "Cornerstone provides a ready workforce. With adaptive HR software designed to unite people, teams, technology, and business, Cornerstone products inspire a work environment of growth, agility, and success for all.",
          "type": "ITComponent",
          "lifecycle": null,
          "tags": [
            "China affected"
