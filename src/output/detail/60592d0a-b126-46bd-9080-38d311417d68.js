export default {
  ...
  "subscriptions": [
    ...
    {
      "firstName": "Philip",
      "lastName": "Axelsson Moberg",
      "displayName": "Philip Axelsson Moberg",
      "email": "philip.axelsson.moberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Anna",
      "lastName": "Krishtal",
      "displayName": "Anna Krishtal",
      "email": "anna.krishtal@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Daniel",
      "lastName": "Hök",
      "displayName": "Daniel Hök",
      "email": "daniel.hok@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    {
      "firstName": "Levy Stefan",
      "lastName": "Brailowsky",
      "displayName": "Levy Stefan Brailowsky",
      "email": "levy.stefan.brailowsky@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    ...
    {
      "firstName": "Felipe",
      "lastName": "Betteloni Lopes",
      "displayName": "Felipe Betteloni Lopes",
      "email": "felipe.betteloni@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Sucheta",
      "lastName": "Biswas",
      "displayName": "Sucheta Biswas",
      "email": "sucheta.biswas@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    ...
    },
    {
      "firstName": "Simon",
      "lastName": "Sandström",
      "displayName": "Simon Sandström",
      "email": "simon.sandstrom@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Mattias",
      "lastName": "Toma",
      "displayName": "Mattias Toma",
      "email": "mattias.toma@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "Conversion",
    "description": "Conversion is used globally in workshops, end of line and in special cases R&D.\nConversion creates the new SOPS file that must be downloaded in the vehicle upon rebuilding.  By using Conversion the workshops will be presented with the list of components needed for a specific rebuild.\nConversion allows for the creation of the Software Update package making a Software update available for a set of all or any vehicles after production. ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "6dbe08d6-4eff-46b0-b20c-b15e497b76c6",
        "displayName": "Vera",
        "description": null,
        "type": "Application",
        "tags": [],
  ...
  "initiatives": [
    {
      "id": "2edf183f-37a7-4dd5-a3a2-6de52298da2c",
    ...
    {
      "id": "e352a659-c421-4117-8e7f-afb21960ed2c",
    ...
    {
      "id": "bd185241-c21d-47fd-aa10-67156fa5eeea",
    ...
    {
      "id": "77ac0fd9-d754-4d9c-ba2a-ac8484f08aea",
    ...
    {
      "id": "33e80a62-31ff-457c-8b12-34fa778f11ee",
    ...
    {
      "id": "0a1e9c92-c6ba-443b-8139-f5a01150c7c9",
      "displayName": "SWS",
      "fullName": "SWS",
      "tags": [],
      "lifecycle": null,
      "subscriptions": [
        ...
        {
          "displayName": "Patrik Rönnqvist",
          "email": "patrik.ronnqvist@scania.com",
          "type": "RESPONSIBLE"
        },
        {
    ...
    {
      "id": "4f4915e6-16e5-4eb3-8439-e67fc984815b",
  ...
  "management": {
    "objects": [
      ...
      {
        "id": "26bce66d-195d-44bd-8b10-8cb0e830d1ea",
        "description": "Define a Fleet of Product As Individuals with an arbitrary number of participating Fleet Members related to one or more Customer Sites.",
        "displayName": "Individual Vehicle and Engine Domain / Product As Individual Entity / Fleet",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "5e12ce0d-b786-4ea3-a8ce-3b42bdebac5e",
        "description": "Fault Correction Campaign represents the situations when Scania has to call back a number of Product As Individuals, caused by some kind of software or hardware fault, that are needed to be corrected for the continuous operations.",
        "displayName": "Repair & Maintenance Domain / Fault Correction Campaign Entity",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "f61be3af-fb4f-4bcf-ab43-bf3aa766ab1a",
        "description": null,
        "displayName": "SOPS - Scania Onboard Product Specification",
        "lifecycle": {
          "asString": "endOfLife",
          "phases": [
            {
    ...
    "interfaceConsume": [
      ...
      {
        "id": "b21d3c9a-31cf-43ef-a864-da4e857e4cb4",
        "description": null,
        "displayName": "OAS Platform / OAS_CO2 Knockdown Structure",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "1196e870-e782-4bf1-875f-4967847a827c",
        ...
        "displayName": "OAS Platform / OAS_OAS_production_dev_findvariantoptioninstructure_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "18a0b613-f1e9-47c0-ab7f-6bb486503f4d",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_development_tcr_vcr_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "cf2ce465-0834-4a63-95de-de04e1b8c0d1",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_development_variantcodeproposer_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "75b2ec65-24e3-42bb-a8d3-b091b5dc4552",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_ecu_assemblyinfo_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "48a7cfcb-d8b3-437f-970d-461f9fca0548",
        "description": "Sending POD SIAM Database\nSending contract SCCO8374\nSCIS210_SIFO_Hyperion",
        "displayName": "Oracle Financials (EBS)_SIFO_Hyperion",
        "lifecycle": {
          "asString": "endOfLife",
          "phases": [
            {
      ...
      {
        "id": "94542e97-5710-4b5e-94ca-e4bc4b198631",
        "description": "A service that provides FPC codes for a specific product individual (C-,V-,SW-spec)",
        "displayName": "PII / PIIFPC_PIIFPC",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "6623c254-3f59-4489-91e6-d28900fb3420",
        "description": null,
        "displayName": "SPISA_Product_Information",
        "lifecycle": {
          "asString": "plan",
          "phases": [
            {
      ...
      {
        "id": "07a0c697-e2c2-4195-ba31-a836dbc7bac3",
        "description": null,
        "displayName": "Technical Information Library_Technical_Information_Library-TIL-Internal-Global IE v2",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "bbfa4185-b0d2-4628-bd32-d1d3483a6bb4",
        "description": null,
        "displayName": "Technical_Information_Library-TIL-Internal-Global IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "20d70d2d-abc9-4f83-adb8-3816b33110ab",
        "description": null,
        "displayName": "WAM_FG -  https://fg.ciam.prod.aws.scania.com/auth/realms/scania",
        "lifecycle": null,
        "tags": [
          "XDS_SAML"
        ]
    ...
    "interfaceProvide": [
      ...
      {
        "id": "e09a06b6-1839-4df9-8218-7634b4c0a8f2",
        "description": null,
        "displayName": "Conversion_Product Adaptations API (PAAPI)",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "aea9140e-6d4c-49ec-ad3b-379656db3474",
        "description": null,
        "displayName": "Conversion_Scania Update Service (SUS)",
        "lifecycle": null,
        "tags": []
      }
    ]
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "44094926-2105-4158-acdf-659b97574f65",
          "displayName": "Docker",
          "category": "software",
          "description": null,
          "type": "ITComponent",
      ...
      "accessControl": [
        {
          "id": "d8c60573-fcfc-469f-a405-6867be5623f7",
          "displayName": "Scania / Scania IT conversion-dev DEV",
        ...
        {
          "id": "4179926d-bb2c-4363-8978-91b98f51d5c6",
          "displayName": "Scania / Scania IT scania-conversion-prod PROD",
          "category": "Access_Control_Item",
          "description": null,
          "type": "ITComponent",
          "lifecycle": {
