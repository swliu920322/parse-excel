export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Ankit",
      "lastName": "Gautam",
      "displayName": "Ankit Gautam",
      "email": "ankit.gautam@scania.com",
      "type": "RESPONSIBLE",
      "role": [
  ...
  "information": {
    "name": "EBO",
    "description": "ETEL is a Back Office system for specification support of truck and bus chassis. The electronic specification created in ETEL is the basis for most central services.  The Back Office tool is a stand-alone application and the specification functionality is accessed via Sales Tools appllications.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "2890ded2-6a71-40c9-b5b7-fa81b58e64aa",
        "displayName": "Central Specification On the Web (CESOW)",
        "description": "A computer program for specification support of truck and bus chassis. The electronic specification created in CESOW is the basis for most central Services.",
        "type": "Application",
        "tags": [],
        "subscriptions": []
      }
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "fb6bc3e7-5366-4736-8d62-fa192d164955",
        ...
        "displayName": "OAS Platform / OAS_OAS_production_ecm_findconditions_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "cb1a0fc2-cf2a-4332-a04f-f926d719b13d",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_exit_complemented_fpc_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceProvide": [
      {
        "id": "4b651936-f24b-4dd1-b041-ee3c468f55e6",
        "description": "Single contract set up for all communications. Market Product and Price information sent from ETEL Back Office and used to update product and price information in SVAS - Communications made via SIAMIP/Broker.  \n\nBetween ETEL BO and SVAS it is purely a receive into SVAS. User exports file from ETEL BO and they arrive into SVAS via QSNADS Distribution Services from a central server in Sweden SSS400 Again these are text files with a pre-defined layout. Receipt is real-time via job CESOWPRT that again runs in subsystem BACKGROUND.\n",
        "displayName": "EBO_SVAS SGB",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
