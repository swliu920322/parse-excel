export default {
  ...
  "information": {
    "name": "NAS",
    "description": "Storage IUBB, Isilon",
    "lifecycle": {
      "asString": "phaseIn",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "2045761c-df96-4d69-95fd-1877c46e1188",
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "ce7abd81-3ef8-4f37-a430-495b765087be",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IU - Infrastructure Services / IUA - Hosting Services / IUAB - Server virtualization &  Storage Technologies",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
