export default {
  ...
  "subscriptions": [
    {
      "firstName": "Magnus",
      "lastName": "Zumaeta",
      "displayName": "Magnus Zumaeta",
      "email": "magnus.zumaeta@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "Marposs Axel",
    "description": "Measurement system with different applications within production - Used at DT (Axel)",
    "lifecycle": {
      "asString": "endOfLife",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "faa80980-0f73-4b30-8dd3-f165cf26abe0",
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "1c38d62f-a867-4d20-9359-1837375ac3c2",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / D - Powertrain Production / DT - Transmissionsmontering / DTO - Axel- och växellådsmontering / DTOP - CVX-montering",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
