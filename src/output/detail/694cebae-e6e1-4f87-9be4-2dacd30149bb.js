export default {
  ...
  "information": {
    "name": "SIFO",
    "description": "Scania Interface Oracle Financials",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "fc295388-00a5-4136-b1d3-63060cfe1459",
    ...
    {
      "id": "70b77825-c654-43b8-b814-02b55ae27337",
    ...
    {
      "id": "d31594a6-2d15-488a-8cf0-175c72ef67bc",
  ...
  "management": {
    "objects": [
      ...
      {
        "id": "d6adaa07-4235-4a96-8ea0-e17985b258bf",
        "description": "Represents all price rules and price plans with different price governing parameters which can be applicable for different Price List Types.",
        "displayName": "Product Portfolio Domain / Pricing Entity / Price",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
