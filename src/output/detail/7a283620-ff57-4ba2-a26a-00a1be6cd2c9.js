export default {
  ...
  "subscriptions": [
    {
      "firstName": "Elie",
      "lastName": "Shamey",
      "displayName": "Elie Shamey",
      "email": "elie.shamey@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    },
    {
      "firstName": "Thomas",
      "lastName": "Gustavsson",
      "displayName": "Thomas Gustavsson",
      "email": "thomas.gustavsson@scania.com",
      "type": "RESPONSIBLE",
      "role": []
    },
    {
    ...
    {
      "firstName": "Anders",
      "lastName": "Hedenstrand",
      "displayName": "Anders Hedenstrand",
      "email": "anders.hedenstrand@scania.com",
      "type": "RESPONSIBLE",
      "role": [
  ...
  "initiatives": [
    {
      "id": "f63f9293-c5db-409e-bdd2-62fcb5a480e2",
    ...
    {
      "id": "5aaab8f7-c78f-4f1c-b141-f0bfe8a4a24b",
      "displayName": "MIO - Maintenance in OAS",
      "fullName": "MIO - Maintenance in OAS",
      "tags": [],
      "lifecycle": null,
      "subscriptions": [
        {
    ...
    {
      "id": "7a89d9e0-9863-4c72-b048-b1a646186011",
    ...
    {
      "id": "1a3d7f87-a6a3-4163-902f-57d9bf935c85",
  ...
  "businessSupport": {
    ...
    "processes": [
      {
        "id": "d45937c4-8f2c-4fdf-8f87-28dd22e128c3",
        "displayName": "Services delivery / Workshop process / 1. Services sales/Arrange Appointment",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
      ...
      {
        "id": "459c4096-22c0-4c24-9e59-32da88239627",
        "displayName": "Services delivery / Workshop process / 2. Workshop planning",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
      ...
      {
        "id": "6cf7dbff-a45a-44af-a864-9ac032fa42d7",
        "displayName": "Services delivery / Workshop process / 4. Workshop Production",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
      ...
      {
        "id": "528c0af6-6f35-4d88-a4c8-62157812dff3",
        "displayName": "Services delivery / Workshop process / 5. Invoicing",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
    ...
    "organisations": [
      ...
      {
        "id": "23fff6bd-f0f3-4c3c-8f23-31c3c11e1fdd",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing / EY - Vehicle Definition and Product Quality / EYS - Vehicle Service Information / EYSE - Projects, Language and Internal Systems",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "626a2dff-c2c1-4ba5-9a96-cda8a02467bb",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing / EY - Vehicle Definition and Product Quality / EYS - Vehicle Service Information / EYSE - Projects, Language and Internal Systems / EYSEO - Development & IT Coordination - Repair, Parts & Maintenance",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "9a69f576-5e75-4544-b569-7d17dc38d027",
        "description": null,
        "displayName": "Workshop Domain / Workshop Stock Capability Entity / Workshop Stock",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "f1919b1f-7cb8-4342-94a1-37375037e53b",
        "description": "Material resources that are required for a work order job shall be listed as part specifications.",
        "displayName": "Workshop Domain / Workshop Work Order Entity / Required Part",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "c3178619-cdbd-4786-98f3-52109d2dbba0",
        "description": "Step by step instructions, parts, equipment and labour standard times needed to carry out the job.",
        "displayName": "Workshop Domain / Workshop Work Order Entity / Work Order Job Instructions",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "4009e1be-86f0-45a2-84d8-68ee9fe96f94",
        "description": null,
        "displayName": "Workshop Domain / Workshop Work Order Entity / Work Order Protocol",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceConsume": [
      {
        "id": "2248859f-143c-4294-9b0f-270ca6bc3cb4",
        "description": null,
        "displayName": "Multi_multi2datalake IE 1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "2c2aca81-0937-4143-b104-f998d072a58f",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_sws_listpartasresources_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "15148086-c43e-4b2d-bdb4-c3548ab2190d",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_sws_listtools_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
