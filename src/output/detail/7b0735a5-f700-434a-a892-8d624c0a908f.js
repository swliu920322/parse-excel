export default {
  ...
  "information": {
    "name": "PRAL",
    "description": "PRoduction ALlocation and validation. \n\nAllocate customer order in time regarding market and components restriction and the customers desired delivery date to final Assembly PRU. Also used for sequencing within an order batch (mixing) at the Chassis PRUs.\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "098ee7f6-fbba-46dd-9408-65dfc3cad53c",
      "displayName": "CALOPS",
      "fullName": "CALOPS",
      "tags": [
        "Maturity Level 2",
    ...
    {
      "id": "1132a947-fe86-4825-aac9-4d1ab772c305",
    ...
    {
      "id": "33c453c6-caa2-4dc7-860c-0ef1efdd7b73",
    ...
    {
      "id": "805a6f68-e317-414b-a755-92d7202547e9",
    ...
    {
      "id": "4ff719d5-93fd-4986-90f3-d741e0b23fcf",
    ...
    {
      "id": "3f5b9a07-d937-4db5-b4b9-511f4edf16c2",
    ...
    {
      "id": "bd7ce98a-e298-4206-97a1-bb52b15649d2",
    ...
    {
      "id": "08bc6c97-f237-47c4-adeb-35fef17fbe89",
  ...
  "chinaInfo": {
    ...
    "ChinaDesign": "VEIO/INAH",
    "ChinaSourcing": "INAH",
    "ChinaPaying": "VEI",
    "ChinaImplementation": "INAH",
    "Chinaverification": "VEIO/INAC",
