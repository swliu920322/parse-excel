export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Rahul",
      "lastName": "Mundhe",
      "displayName": "Rahul Mundhe",
      "email": "rahul.mundhe@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Developer"
      ]
  ...
  "information": {
    "name": "CALOPS",
    "description": "Central calendar system at Scania",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "cf2fc768-53ed-4979-bdb6-3a17397b3739",
        "displayName": "Master Calendar",
        "description": "Application for creating and maintaining internal calendar for all production dates at Scania. ",
        "type": "Application",
        "tags": [
          "Not China affected",
          "Maturity Level 1"
  ...
  "initiatives": [
    {
      "id": "8b8f6434-9d5b-4913-9a3a-bf65a70c4760",
      "displayName": "CALOPS",
      "fullName": "CALOPS",
      "tags": [
        "Maturity Level 2",
    ...
    {
      "id": "79ad7346-4ca4-4a11-a052-8eb980e88c14",
    ...
    {
      "id": "f5cd8e26-1da0-4c99-8a61-4616a7e67230",
    ...
    {
      "id": "5295e1a0-04f7-4d87-8dc0-358e25751972",
    ...
    {
      "id": "03c895ea-e419-47b6-88d3-d9391fe57dc4",
    ...
    {
      "id": "70714b9a-1a10-4601-b6e9-0503b66b042f",
    ...
    {
      "id": "1cbd647c-f3f1-4904-9dec-a4edf6517df6",
  ...
  "management": {
    "objects": [
      {
        "id": "6fd77558-cf54-4b1a-ab59-b44447605a1b",
        "description": "Calendar is the uniting level to manage different versions of calendar with Calendar days and book able time and booked events.",
        "displayName": "General Information Objects Domain / Generic Calendar Entity / Calendar",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "tech": {
    "itComponents": {
      "software": [
        ...
        {
          "id": "f5bb3650-fef9-4fec-82b7-e7dbeca14395",
          "displayName": "Java",
          "category": "software",
          "description": "A Generic Java Component, pls use a specific version software component to refere to the Java your application uses.",
          "type": "ITComponent",
          "lifecycle": {
            "asString": "active",
            "phases": [
  ...
  "chinaInfo": {
    ...
    "ChinaDesign": "INAH/OPPC",
    "ChinaSourcing": "INAH",
    "ChinaPaying": "VEI",
    "ChinaImplementation": "INAH/OPPC",
    "Chinaverification": "INAH/OPPC",
    "ChinaOperations": "INAH/OPPC"
  }
}