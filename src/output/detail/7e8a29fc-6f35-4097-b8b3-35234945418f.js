export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "claudemir.figueiredo@scania.com",
      "email": "claudemir.figueiredo@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "OneDrive",
    "description": "OneDrive for Business is an integral part off Office 365 and provides place in the cloud where you can store, share (both internal and external), and sync your work files. You can update and share your files from any device with OneDrive for Business.You can even work on Office documents with others at the same time.\r\n\r\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "ad2b931d-f6f9-4dfb-9453-3aea017ffe53",
    ...
    {
      "id": "61591ca8-f940-4ea4-8d30-9cb212616572",
