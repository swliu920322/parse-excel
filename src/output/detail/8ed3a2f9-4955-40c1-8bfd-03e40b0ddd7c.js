export default {
  ...
  "subscriptions": [
    {
      "firstName": "Anju",
      "lastName": "Naveenraj",
      "displayName": "Anju Naveenraj",
      "email": "anju.naveenraj@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Catharina",
      "lastName": "Nyberg",
      "displayName": "Catharina Nyberg",
      "email": "catharina.nyberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    },
    {
      "firstName": "Kristofer",
      "lastName": "Enelund",
      "displayName": "Kristofer Enelund",
      "email": "kristofer.enelund@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Information Owner"
      ]
  ...
  "information": {
    "name": "Scania Configurator",
    "description": "Scania Configurator is a online truck configurator that enables Scania’s customers to configure their own truck.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "08f1f78a-8a79-40ea-858a-b6490b77b6d2",
        "displayName": "I. Presales, Sales and Customer Relationship Management",
        "description": "Ability to manage customer relations and steer presales and sales activities. Ability to reach the customers via resellers and partners. Ability to configure complete solutions to meet customer needs.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
        ...
        "subscriptions": [],
        "tags": [
          "MilkyWay area 17. Sales & Marketing"
        ]
      },
      {
  ...
  "management": {
    "objects": [
      {
        "id": "9a66d5a5-0e4a-4dbb-8a32-3bf974605431",
        "description": null,
    ...
    "interfaceConsume": [
      {
        "id": "36f70c4c-08fd-49b0-9b58-53a2e735a316",
        "description": "This is the api between EYS and scania configurator",
        "displayName": "Explore Your Scania_eys-configurator-api IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceProvide": [
      {
        "id": "44decb44-0608-44ef-89b8-26cbb1886ec2",
        "description": null,
        "displayName": "Scania Configurator_DealerService",
        "lifecycle": null,
        "tags": []
      },
      {
      ...
      {
        "id": "70dc1a8a-47f1-4531-8bfa-d54b69cb6c3f",
        "description": null,
        "displayName": "Scania Configurator_SPISA",
        "lifecycle": null,
        "tags": []
      }
    ]
