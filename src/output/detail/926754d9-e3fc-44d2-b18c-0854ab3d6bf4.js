export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "johan.xy.olsson@scania.com",
      "email": "johan.xy.olsson@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "SCCM servers",
    "description": "SCCM infrastructure servers",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "bd5b726b-06a1-4aad-9642-2e1bea3f1415",
    ...
    {
      "id": "83ef09bd-0920-4a74-a81f-ce8f5ba4a68b",
