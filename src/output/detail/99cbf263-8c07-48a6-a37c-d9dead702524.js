export default {
  ...
  "information": {
    "name": "Scania Account Tool",
    "description": "SAT maintains and adds new user accounts in MyCompass (LMS). ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "19cd9d29-d415-415a-b6c6-6cc1da2c70cf",
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "00621450-7b75-49fd-8baa-7c86b68fd684",
        "description": null,
        "displayName": "Aditro L_E&O_user_profile",
        "lifecycle": null,
        "tags": []
      }
    ],
  ...
  "tech": {
    "itComponents": {
      ...
      "service": [
        {
          "id": "0c502eb8-93e0-4ce7-b43d-c31d28c7cac4",
