export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "carl-johan.sjostedt@scania.com",
      "email": "carl-johan.sjostedt@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "john.kroon@scania.com",
      "email": "john.kroon@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "anders.larsson@scania.com",
      "email": "anders.larsson@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "jonny.andersson@scania.com",
      "email": "jonny.andersson@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "reno.filla@scania.com",
      "email": "reno.filla@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "stephan.zentner@scania.com",
      "email": "stephan.zentner@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    ...
    },
    {
      "firstName": "William",
      "lastName": "Larsson",
      "displayName": "William Larsson",
      "email": "william.larsson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
  ...
  "information": {
    "name": "ICD/ICS",
    "description": "Scania Individual Chassis Drawings (Scania ICD) and Scania Individual Chassis Specifications (Scania ICS).",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "239c8243-4473-4719-91c3-f337336fb8cd",
      "displayName": "CALOPS",
      "fullName": "CALOPS",
      "tags": [
        "Maturity Level 2",
    ...
    {
      "id": "c2d8f29c-f6ec-4140-a522-d1e801127101",
  ...
  "management": {
    ...
    "interfaceConsume": [
      ...
      {
        "id": "3d0fe22b-8fe3-4d9e-a367-514c3356775a",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_geo_icdgposition_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "a34b2896-2390-4693-8b0f-e9f756b5937d",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_geo_sidemember_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "e86cfaee-dc70-4d0a-9a1f-30a4666dee3f",
        "description": "OAS runs the request as the user specified in the jwt claim 'preferred_username'. See OAS documentation for description of the request and response headers, parameters and body. The feature SPNEGO is not supported when using WSO2 to call OAS rest services. API deployed with SAPS.",
        "displayName": "OAS Platform / OAS_OAS_production_getcertificates_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceProvide": [
      {
        "id": "0719f3af-816f-43ec-bf38-34958bfdecb2",
        "description": "ICDICS Document Service API provides any available documents based on chassis id of the vehicle.",
        "displayName": "ICD/ICS_ICDICS-DigitalPassport IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "tech": {
    "itComponents": {
      ...
      "accessControl": [
        {
          "id": "388a96a8-47a5-4a11-8539-1b7c19fe3eec",
          "displayName": "Scania / Scania IT scania-icdics-prod PROD",
        ...
        {
          "id": "b444050a-8fe4-4619-b351-ef935cf063d5",
          "displayName": "Scania / Scania IT scania-icdics-staging-prod PROD",
          "category": "Access_Control_Item",
          "description": null,
          "type": "ITComponent",
          "lifecycle": {
