export default {
  ...
  "subscriptions": [
    {
      "firstName": "Robin",
      "lastName": "Högberg",
      "displayName": "Robin Högberg",
      "email": "Robin.Hogberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    },
    {
      "firstName": "Aart",
      "lastName": "Foppen",
      "displayName": "Aart Foppen",
      "email": "aart.foppen@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "LayCAD",
    "description": "LayCAD is a CAD application for designing of factory layouts, comprising of Autodesk AutoCAD Architecture and Siemens FactoryCAD software packages",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "dependencies": {
    ...
    "children": [
      {
        "id": "d53698c0-a460-4bbe-bcc4-d26d31575da3",
        "activeFrom": "2020-02-18",
        "activeUntil": null,
        "description": null,
        "displayName": "LayCAD / Factorycad",
        "type": "Application",
        "lifecycle": null,
        "tags": [],
        "subscriptions": []
  ...
  "initiatives": [
    {
      "id": "856cfb40-7369-45ae-8fb0-5391a47b6514",
    ...
    {
      "id": "09b1d794-262e-407a-b923-fe2194561196",
    ...
    {
      "id": "4aaddbcd-e558-4ec5-a40d-7ff3cdf98fcc",
    ...
    {
      "id": "06c02273-139b-42e3-a313-8f7b0958bd8e",
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "482a20b7-107f-4b91-853c-8048961ae2f3",
        "displayName": "M. Manage Assets / Facility Management / Facility Design",
        "description": "The ability to design facility layout in order to maximize the business effectiveness in production process and meet the needs of employees.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "organisations": [
      ...
      {
        "id": "5980e00b-d3df-4100-a04b-6f12f61113cc",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / VE - Global Industrial Development / VEE - Global Industrial Engineering Development / VEEM - Industrial Engineering Manufacturing",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      ...
      {
        "id": "7880007e-8814-493f-99d0-c064a43e4f40",
        "description": null,
        "displayName": "Drawings (2D)",
        "lifecycle": {
          "asString": "endOfLife",
          "phases": [
            {
  ...
  "tech": {
    "itComponents": {
      ...
      "service": [
        {
          "id": "fd559106-bf86-4b60-a27c-7dc8ead4a3bf",
          "displayName": "Microsoft / Azure File Storage",
          "category": "service",
          "description": "Azure Files offers fully managed file shares in the cloud that are accessible via the industry standard Server Message Block (SMB) protocol. Azure file shares can be mounted concurrently by cloud or on-premises deployments of Windows, Linux, and macOS.",
          "type": "ITComponent",
          "lifecycle": {
            "asString": "active",
            "phases": [
