export default {
  ...
  "information": {
    "name": "Truckcam Wheeladjustment",
    "description": "Alignment of axels - Wheeladjustment at DT",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "1724dd19-0a4d-484b-a6d3-4b05430607fe",
    ...
    {
      "id": "7c22951b-9292-4ca8-86f8-9510c2405aec",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "f8477c17-0468-453e-9ace-5031056416c7",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / D - Powertrain Production / DT - Transmissionsmontering / DTO - Axel- och växellådsmontering / DTOA - Bakaxelmontering",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "e7ed3b4d-0fec-41ac-a8d4-d1fa6950a08d",
        "description": null,
        "displayName": "Production Domain / Material Capability Entity / Material Attribute",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "TCT/TCM",
    "ChinaDesign": "INGA",
    "ChinaSourcing": "INGA",
    "ChinaPaying": "TCT/TCM",
    "ChinaImplementation": "INGA",
    "Chinaverification": "TCT/TCM",
    "ChinaOperations": ""
  }
}