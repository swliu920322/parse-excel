export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "evelyn.goossens@scania.com",
      "email": "evelyn.goossens@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "CAWAT",
    "description": "CAWAT - Cost and Weight Analyses Tool is used to make pre-calculations on new or changed construction on Scania vehicles. The system produces a cost & weight calculation for use in the Scania PDM process to make decision to do the change or not. ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "c46b0ad9-1bc5-40e3-9f81-3e25beb01866",
    ...
    {
      "id": "353c5ae3-68a7-43bb-997c-fa9c0b2b0659",
  ...
  "businessSupport": {
    ...
    "processes": [
      ...
      {
        "id": "90c43253-f02e-4828-9d99-a33d23a471c1",
        "displayName": "Order to delivery / Major support processes within Production & Logistics / Central Finance",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
    ...
    "organisations": [
      ...
      {
        "id": "063d2793-ca0c-4975-b412-4b1b6e383e86",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing / EF - Controlling Research & Development",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
