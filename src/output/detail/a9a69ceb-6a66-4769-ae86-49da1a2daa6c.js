export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Roman",
      "lastName": "Åberg",
      "displayName": "Roman Åberg",
      "email": "roman.aberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "EWOK",
    "description": "The EWOK system has the purpose to support production, translation, storing and exporting information and images for Scania After Market products. \r\nInformations inside the system are for example Drivers Manual (DRM), Scania Tools (STO), Service Data (SRD) and Workshop Manuals (WSM). ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "fb441a06-2eca-4b45-a200-a0766e74d375",
        "displayName": "Wings",
        "description": null,
        "type": "Application",
        "tags": [],
  ...
  "initiatives": [
    {
      "id": "caf8a8ef-4a52-45c1-9bea-95ed09c5256f",
    ...
    {
      "id": "b8a5a490-14b2-4581-9d1d-c54504a5258a",
    ...
    {
      "id": "0c892efc-707c-4a07-888d-406442ac0702",
    ...
    {
      "id": "0fbe1a65-f8e2-4e25-8b91-7d83b908aedd",
  ...
  "management": {
    ...
    "interfaceProvide": [
      {
        "id": "89d59c92-b2ea-4139-950a-0457bbd1a053",
        "description": null,
        "displayName": "EWOK_EWOK-MULTI",
        "lifecycle": null,
        "tags": []
      }
    ]
