export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Pierre",
      "lastName": "Ternvald",
      "displayName": "Pierre Ternvald",
      "email": "pierre.ternvald@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
    },
    {
      "firstName": "Charlotte",
      "lastName": "Daniels",
      "displayName": "Charlotte Daniels",
      "email": "charlotte.daniels@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    },
    {
      "firstName": "Mattias",
      "lastName": "Järnhäll",
      "displayName": "Mattias Järnhäll",
      "email": "mattias.jarnhall@scania.com",
      "type": "RESPONSIBLE",
      "role": [
  ...
  "information": {
    "name": "Sales Portal",
    "description": "Sales Portal is a browser based application which offers quotation functionality for the Scania sales organization. \n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "b305b95f-f1b0-4ea8-bc40-26d9a3d6fa49",
        "displayName": "I. Presales, Sales and Customer Relationship Management / Quotation & Deal Management",
        "description": "Create, manage offerings and customer deals.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "processes": [
      ...
      {
        "id": "45a0a739-1000-4240-8f88-f6170484aebd",
        "displayName": "Sustainable Transport Solution / Sales / Solution Sales / Propose",
        "description": "This is the time when our quotation is finalized, and the sales representative can present and explain our solution offering. ",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "bf82ac96-c010-45ae-86a7-ab48d1db4ae7",
        "displayName": "Sustainable Transport Solution / Sales / Solution Sales / Specify",
        "description": "Specify is designed to be the place where Scania solution offering is defined based on customer/ prospect needs and requirements.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "79119109-e0f7-4d51-89b9-c13742d27b25",
        "description": "DATA FLOW FOR (Vehicle Sales) CUSTOMERS/CONTACTS  \n1.\tAutoline produces daily extract CSV files of new/updated customer contacts. \n2.\tSGB400 – daily routines run at 5am and 11:40am to retrieve CSV files via FTPS from Autoline and send them via SFTP to Sales Portal (system used to create vehicle sales quotations/orders)\n",
        "displayName": "Autoline SGB 8.32_Sales Portal",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "f16919fb-39de-4a45-ac65-8edf5beb76c3",
        "description": null,
        "displayName": "CAVA_Driving_Performnace_API",
        "lifecycle": null,
        "tags": []
      },
      {
      ...
      {
        "id": "61b62cec-f78a-4bfc-bfae-090f5f06bf5e",
        "description": null,
        "displayName": "SECM_ETEL API",
        "lifecycle": {
          "asString": "plan",
          "phases": [
            {
      ...
      {
        "id": "18296d68-0a34-41c7-9831-ed2020d944a9",
        "description": null,
        "displayName": "SQS_ScaniaSQS-GreatBritain IE 1.0.0",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "9b789959-f7e3-444e-ab67-a784d1b35067",
        "description": null,
        "displayName": "SQS_ScaniaSQSAPI-Gateway IE 1.0.0",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
