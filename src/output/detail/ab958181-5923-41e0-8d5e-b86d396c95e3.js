export default {
  ...
  "subscriptions": [
    {
      "firstName": "Jennie",
      "lastName": "Friberg",
      "displayName": "Jennie Friberg",
      "email": "jennie.friberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    },
    {
      "firstName": "Suzanne",
      "lastName": "Lundberg",
      "displayName": "Suzanne Lundberg",
      "email": "suzanne.lundberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Muhammad",
      "lastName": "Junaid",
      "displayName": "Muhammad Junaid",
      "email": "muhammad.junaid@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
  ...
  "information": {
    "name": "TIA",
    "description": "Application for risk observation and incident reporting of work environment incidents. There are also risk management assessment modules. The application supports the occurrence handling process.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "dddcf512-a54b-4be8-ab8a-2532cf32ab1b",
        "displayName": "SAM",
  ...
  "initiatives": [
    {
      "id": "ef1c4afa-58c9-4298-8321-b1e30ecbcaac",
    ...
    {
      "id": "22859468-c2c7-43c4-837b-6b3bc79f6fa5",
    ...
    {
      "id": "cf0e383a-68e1-42a7-972b-83b6778adb79",
    ...
    {
      "id": "70aadf38-8564-42f3-a098-8793a4717478",
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "7562b5da-79ef-40ae-9b54-0c4762bafb68",
        "displayName": "O. People and Talent Management / Health Management",
        "description": "Eliminate and prevent work-related causes of ill-health in order to create a safe and secure work environment. Includes first aid, treatment and rehabilitation.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "organisations": [
      ...
      {
        "id": "da600812-960f-4a98-ad5f-184d720835b0",
        "displayName": "Scania - Scania CV AB / P_HR - People &  Culture / HA - Global People Services / HAS - People Services Sweden / HASH - Global SHE / HASHF - Global Safety & Health Office / HASHFS - Group Safety & Health",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    ...
    "interfaceConsume": [
      ...
      {
        "id": "9b4597ff-dd87-482f-b526-ebf40da9fbd2",
        "description": null,
        "displayName": "WAM_SAT -  https://api.sat.prod.aws.scania.com",
        "lifecycle": null,
        "tags": [
          "XDS_SAML"
        ]
  ...
  "tech": {
    "itComponents": {
      ...
      "service": [
        {
          "id": "f37bca9f-4ffd-49ac-958a-b3c60ededdd6",
          "displayName": "AFA Försäkring IA SaaS",
          "category": "service",
          "description": null,
          "type": "ITComponent",
          "lifecycle": null,
