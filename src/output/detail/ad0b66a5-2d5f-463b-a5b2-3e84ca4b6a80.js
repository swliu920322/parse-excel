export default {
  ...
  "subscriptions": [
    {
      "firstName": "Mikael",
      "lastName": "Svanholm",
      "displayName": "Mikael Svanholm",
      "email": "mikael.svanholm@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "DTS WEB",
    "description": "This is a application used for quality control. It is a measurement database for part fitment data: DTS, Dimensional Technical Specification. Developed locally in Oskarshamn.\n\nYou find the application and more information here:\nhttps://inline.scania.com/scripts/cgiip.exe/WService=inline/cm/pub/showdoc.p?docfolderid=236903&docname=home\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "75c1fd00-90ab-40b4-abf5-8d64cced5642",
    ...
    {
      "id": "f68db696-8e71-42bd-b8f5-5023a9ae534b",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "65aad2b7-0b74-479e-8374-3616ccdb14fc",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / M - Chassis, Cab and Bus Production / MC - Cab Assembly / MCQ - Quality / MCQA - Cab Assembly Quality",
        "usageType": null,
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "6665424c-8822-4760-be2d-e1b85ec2c3ae",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / M - Chassis, Cab and Bus Production / MP - Production Introduction / MPC - Engineering",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    ...
    "interfaceProvide": [
      {
        "id": "f1f695cf-e6ce-41ae-8c6b-bd6dd2a344ed",
        "description": null,
        "displayName": "DTS WEB_http://dtsweb.global.scd.scania.com",
        "lifecycle": null,
        "tags": [
          "China affected"
        ]
