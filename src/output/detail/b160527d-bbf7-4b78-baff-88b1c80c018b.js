export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Henrik",
      "lastName": "Fagerlund",
      "displayName": "Henrik Fagerlund",
      "email": "henrik.fagerlund@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    {
      "firstName": "Praveen Balaji",
      "lastName": "Govindasamy",
      "displayName": "Praveen Balaji Govindasamy",
      "email": "praveen-balaji.govindasamy@scania.com",
      "type": "RESPONSIBLE",
      "role": [
  ...
  "information": {
    "name": "ComOn",
    "description": "Content management system for Scania public websites, Scania.com as well as dealer sites, distribtor sites and production sites. China affected only on a business level, no backend integrations, frontend  use of baidu maps.\n\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "c8e87a55-51d6-478a-8baf-0b2f2662e682",
      "displayName": "ComOn",
      "fullName": "ComOn",
      "tags": [
        "Maturity Level 2"
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "02224f5b-bddc-4530-a8f3-fe8202e364a2",
        "displayName": "Scania - Scania CV AB / P_C - Communications & Sustainability / CD - Communications Development",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    ...
    "interfaceProvide": [
      {
        "id": "cd863e63-7f65-4d8b-9245-20846c0238b1",
        "description": null,
        "displayName": "ComOn_Bodybuilder - https://bodybuilder.scania.com",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "3e67b41d-6b8a-48ae-a29a-c022bc6fb16c",
        "description": null,
        "displayName": "ComOn_Presales - https://presales.scania.com",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "e10f7622-aa9a-4f6b-89b9-96eaae61230a",
        "description": null,
        "displayName": "ComOn_www.scania.com",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "tech": {
    "itComponents": {
      "software": [
        ...
        {
          "id": "a950f3b9-e424-4541-817d-304836c89437",
          "displayName": "Java / Oracle Java Development Kit 1.8",
          "category": "software",
          "description": "JDK is a superset of the JRE, and contains everything that is in the JRE, plus tools such as the compilers and debuggers necessary for developing applets and applications. The Java Runtime Environment (JRE) provides the libraries, the Java Virtual Machine, and other components to run applets and applications written in the Java programming language.",
          "type": "ITComponent",
          "lifecycle": {
            "asString": "phaseOut",
            "phases": [
