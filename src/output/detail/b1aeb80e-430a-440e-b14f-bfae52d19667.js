export default {
  ...
  "subscriptions": [
    {
      "firstName": "Gustav",
      "lastName": "Kynnefjäll",
      "displayName": "Gustav Kynnefjäll",
      "email": "gustav.kynnefjall@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "CMake",
    "description": "Generates build scripts.\n\nBuilding system that keep track of building sequences. Building tool to merge ECU BOOT, ECU SW. Building tool to merge C-code and model based code.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "e4348985-9998-4275-bf73-fcbebe2c3d16",
    ...
    {
      "id": "62a4b07f-45ce-42da-b0a7-80ca3ac221ee",
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "4aa811b2-dbc4-45a9-9f29-489ca778a7ae",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "500974c0-c81a-4428-96ea-8521cde73b13",
        "displayName": "Scania - Scania CV AB / P_RDP - R&D and Purchasing / EN - Powertrain Development / ENE - Powertrain Control / ENEP - Control System Platform / ENEPS - Software",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "4cea5f75-2088-448e-ad94-0bfbcaff9c48",
          "displayName": "Microsoft Windows Enterprise 11",
          "category": "software",
          "description": null,
          "type": "ITComponent",
          "lifecycle": null,
