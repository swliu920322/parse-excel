export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "anna-lena.stromsten@scania.com",
      "email": "anna-lena.stromsten@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "Employee Satisfaction Barometer",
    "description": "Scanias solution to perform Employee Surveys.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "d7eca4d8-4982-4ac3-8dcf-1f96b5573cd5",
        "displayName": "StiBam",
        "description": null,
        "type": "Application",
        "tags": [],
  ...
  "initiatives": [
    {
      "id": "3ee694e0-6c72-43d4-b088-c1cdd42ab201",
    ...
    {
      "id": "b346d08e-a611-48fa-be82-d1bf8e76c203",
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "ce4fb7de-1fe9-49dd-bc85-f5e2789d10a1",
        "displayName": "O. People and Talent Management / Health Management / Well-being Management",
        "description": "The ability to handle all aspects of working life, from the quality and safety of the physical environment, to how workers feel about their work, their working environment, the climate at work and work organization.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "processes": [
      {
        "id": "360f8a31-4958-45f0-9233-c8fbdd81bd5c",
        "displayName": "Supporting processes / Global HR",
        "description": null,
        "lifecycle": {
          "asString": "plan",
          "phases": [
      ...
      {
        "id": "f94ff73e-4e3c-4fbd-bd65-2e5c20cb86eb",
        "displayName": "Supporting processes / Human Resource SWE",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
    ...
    "organisations": [
      ...
      {
        "id": "9d674dae-9cc6-44c4-8ca2-5c06f7875db7",
        "displayName": "Scania - Scania CV AB / P_HR - People &  Culture / HA - Global People Services / HAG - People Services Group / HAGP - Global People Analytics",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "77ff768c-e60e-47ca-bcff-90fb120d671c",
        "description": null,
        "displayName": "Human Resources Domain",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceConsume": [
      {
        "id": "938e8af0-cfd7-4cec-b738-cfd53fa8e563",
        "description": null,
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "f83013eb-66fb-40d6-956a-567a48a8f6a2",
          "displayName": "Kantar",
          "category": "software",
          "description": null,
          "type": "ITComponent",
