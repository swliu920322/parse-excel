export default {
  ...
  "subscriptions": [
    {
      "firstName": "Fabio",
      "lastName": "Garcia Junior",
      "displayName": "Fabio Garcia Junior",
      "email": "fabio.garcia.junior@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
    ...
    },
    {
      "firstName": "Daniel",
      "lastName": "Abbay",
      "displayName": "Daniel Abbay",
      "email": "daniel.abbay@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
    },
    {
      "firstName": "Robin",
      "lastName": "Nemati",
      "displayName": "Robin Nemati",
      "email": "robin.nemati@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
    },
    {
      "firstName": "Anders",
      "lastName": "Isacsson",
      "displayName": "Anders Isacsson",
      "email": "anders.isacsson@scania.com",
      "type": "OBSERVER",
      "role": [
        "Developer"
      ]
  ...
  "information": {
    "name": "ECU compare",
    "description": "Compares vehicles configurations against newer hardware/software and recommends which version should be installed. \nThe results that is shown in ECU Compare is based on data (approvals/restrictions)  in Delivery Data Base. \nECU Compare is used by test drivers and those wanting to update vehicles to a specific status. \n\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "2cfaaf3a-7d22-42e8-98dd-11ca9e9c2cd2",
    ...
    {
      "id": "87256a59-750b-478c-9c48-35135f92b344",
    ...
    {
      "id": "0ced9fe7-d28e-4692-b171-ab6982201977",
