export default {
  ...
  "subscriptions": [
    ...
    {
      "firstName": "Ramaswamy Arumugam",
      "lastName": "Shanbagakumar",
      "displayName": "Ramaswamy Arumugam Shanbagakumar",
      "email": "kumar.shanbaga@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
  ...
  "information": {
    "name": "PartTerm",
    "description": "PartTerm, supports download of part terms in different languages. Starts via SAIL",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "ac5ca10e-b140-4794-be8b-e54bcde7140a",
      "displayName": "Price Point",
      "fullName": "Price Point",
      "tags": [
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "5cc3b982-2c0c-47e6-9de3-e3f93521c15b",
        "displayName": "I. Presales, Sales and Customer Relationship Management / Solution Management",
        "description": "Ability to handle the solution portfolio, the products and services that Scania sell and how they are packed together. Define a global pricing structure and individual market prices.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
