export default {
  ...
  "subscriptions": [
    {
      "firstName": "Per-Erik",
      "lastName": "Einéus",
      "displayName": "Per-Erik Einéus",
      "email": "per-erik.eineus@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Lukas",
      "lastName": "Varli",
      "displayName": "Lukas Varli",
      "email": "lukas.varli@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
    },
    {
      "firstName": "Berzat",
      "lastName": "Musheski",
      "displayName": "Berzat Musheski",
      "email": "berzat.musheski@scania.com",
      "type": "RESPONSIBLE",
      "role": []
    },
    {
      "firstName": "Per",
      "lastName": "Michel",
      "displayName": "Per Michel",
      "email": "per.michel@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "PricePoint",
    "description": "PricePoint from Vendavo is a standard system used for administrating parts prices and discounts within Sales and Marketing and the Business Unit Scania Sweden. PricePoint also handles Price Revisions including simulation and Campaign Pricing..",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "653e640c-e9f4-42ea-90fe-524990ae1e8f",
        "displayName": "PRIME FI",
        "description": "Parts Retail Price System",
        "type": "Application",
        "tags": [
          "Maturity Level 1"
        ],
  ...
  "initiatives": [
    {
      "id": "232e221c-ee88-4202-8248-73102878fa6d",
      "displayName": "Implement PricePoint TH",
      "fullName": "Implement PricePoint TH",
      "tags": [],
      "lifecycle": {
        "asString": "endOfLife",
        "phases": [
  ...
  "tech": {
    "itComponents": {
      "software": [
        ...
        {
          "id": "e22465fa-4c92-48e8-a478-04b4d455d0ac",
          "displayName": "vendavo Pricepoint",
          "category": "software",
          "description": "Vendavo Pricepoint is a cloud-based, centralized price management solution whereby pricing is managed by segment, optimized in real-time with dynamic local market factors and competitive intelligence, and supported by a user-defined pricing intelligence analytics dashboard that enables fast-decision making.",
          "type": "ITComponent",
          "lifecycle": {
            "asString": "active",
            "phases": [
