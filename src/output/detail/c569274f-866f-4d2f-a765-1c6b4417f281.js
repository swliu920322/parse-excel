export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "anu-kalidas.muralidharan.pillai@scania.com",
      "email": "anu-kalidas.muralidharan.pillai@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    ...
    },
    {
      "firstName": "Tony",
      "lastName": "Wallin",
      "displayName": "Tony Wallin",
      "email": "tony.wallin@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
  ...
  "information": {
    "name": "SCCM client",
    "description": "Agent that is installed on clients that provide the management function as application installations, software inventory as well as hardware inventory to the SCCM infrastructure database.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "ba720160-d2dc-4fcf-ac3a-556dc1774bd7",
    ...
    {
      "id": "fc804b76-4165-45c0-b704-0ae70c346bb9",
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "6989654c-0204-4058-b799-26ca1749c06a",
          "displayName": "Microsoft System Center Configuration Manager",
          "category": "software",
          "description": null,
          "type": "ITComponent",
          "lifecycle": null,
