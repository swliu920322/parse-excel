export default {
  ...
  "information": {
    "name": "CLA",
    "description": "- An additional GLOBAL domain user account\r\n- Connected to specified node(s); account can be used on several nodes and multiple accounts can be used on the same node. \r\n- To be used as required or ”Run as different user”/”Run as administrator”",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "af4dd3b7-037c-45ed-be8c-01280619f375",
