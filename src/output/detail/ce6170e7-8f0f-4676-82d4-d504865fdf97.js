export default {
  ...
  "information": {
    "name": "Scania Product Individual Information",
    "description": "SPII is a web application to display CHIN Aftersales data. It is possible to search for General,Technical & certificate Information for a Bus, truck or an I/M Engine. It is also possible to delivery report products and to perform bulk searches for products based on selected filters. It is also possible to import, export & view SOPS files and SOPS data. Since spring 2020 trailer and add-on information is also available.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "fa6d1e3c-1d53-4351-b2c9-af994bbdae1c",
      "displayName": "Phoenix - IT Workstream",
      "fullName": "Phoenix - IT Workstream",
      "tags": [],
      "lifecycle": null,
      "subscriptions": []
    },
    {
      "id": "50ff1aaa-bf2a-44d7-905f-3e7451c03b2d",
    ...
    {
      "id": "5f86e107-c8b6-42ad-8198-69a345942311",
    ...
    {
      "id": "20e9510b-797f-45fe-b689-3ea3add342e7",
    ...
    {
      "id": "919da833-3225-4426-8a1b-dac4768bff99",
