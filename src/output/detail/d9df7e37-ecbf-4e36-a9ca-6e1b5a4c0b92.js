export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Pavani",
      "lastName": "Sakaray",
      "displayName": "Pavani Sakaray",
      "email": "pavani.sakaray@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
    },
    {
      "firstName": "Pranav",
      "lastName": "Bajpai",
      "displayName": "Pranav Bajpai",
      "email": "pranav.bajpai@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Architect"
      ]
  ...
  "information": {
    "name": "PackIT",
    "description": "Packaging Instructions for Production and Parts Logistics",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
    ...
    "predecessor": [
      {
        "id": "8f1a55cc-c2e5-481d-a0b6-b3203cbea266",
        "displayName": "SPIS",
        "description": null,
        "type": "Application",
        "tags": [],
  ...
  "initiatives": [
    {
      "id": "4e9b756d-757f-4f08-88db-17f9226027a2",
    ...
    {
      "id": "6f2c8406-864f-4bce-8f3b-7711d7904c63",
    ...
    {
      "id": "b8bd6b15-b6e2-4a46-a78e-c14ab1489573",
    ...
    {
      "id": "1ce69baf-6acf-4e82-b68e-64d0b36f426d",
    ...
    {
      "id": "225fba8e-8e20-41b3-b2f1-e65bd71a139d",
    ...
    {
      "id": "f479e037-01bd-48f4-9386-70ab7e59d719",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "d4f95b30-21f3-4d74-b230-015d423a612b",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / O - Logistics / OL - Scania Logistics Nordic",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
      ...
      {
        "id": "624d1af7-8d7c-4971-bbae-0988bef2cf53",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / O - Logistics / OL - Scania Logistics Nordic / OLS - Logisitc Centre Södertälje / OLSE - Logistics Centre - Chassis & Transmission Inbound / OLSEL - Packaging Handling & Loading",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "ea513a04-8125-4596-bcea-1e878050056b",
        "description": "packaging code is a short-hand instruction to quickly understand a packaging instruction. For transport and storing it defines the outer packaging. .",
        "displayName": "Logistics Domain / Packaging Development Entity / Packaging Code",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "6f7c682e-3810-4c3f-ba21-a0fb2c82a9e0",
        "description": "packaging instruction is instructions to suppliers how the part or/and material is to be packed.",
        "displayName": "Logistics Domain / Packaging Development Entity / Packaging Instruction",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "eff18a92-03c7-4dea-b9e6-7318b0b623f5",
        "description": null,
        "displayName": "Logistics Domain / Physical product Packaging Entity / Packaging Material",
        "lifecycle": {
          "asString": "endOfLife",
          "phases": [
            {
    ...
    "interfaceConsume": [
      {
        "id": "7c12fdc7-0d84-4f2a-9ac0-324a30096683",
        "description": null,
        "displayName": "WAM_PackIT -  https://packit.scania.com/",
        "lifecycle": null,
        "tags": [
          "XDS_SAML-groups"
        ]
      ...
      {
        "id": "2d9f230e-2450-404c-ae63-ee2d5927636e",
        "description": null,
        "displayName": "WAM_PackIT - https://packit.scania.com",
        "lifecycle": null,
        "tags": [
      ...
      {
        "id": "918e2438-51f7-401f-b06d-1be9c7b90ace",
        "description": null,
        "displayName": "WAM_PackIT - https://packitnew.scania.com",
        "lifecycle": null,
        "tags": [
          "XDS_RP"
        ]
    ...
    "interfaceProvide": [
      ...
      {
        "id": "a73390bb-1fd5-42a1-bef0-c194579c38a6",
        "description": "Package Instruction data From PackIT to Embasy ",
        "displayName": "PackIT_EmbasyPIService IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "chinaInfo": {
    ...
    "LicenceStatus": null,
    "ChinaRequirements": "OL/ON",
    "ChinaDesign": "INAD/OL/ON",
    "ChinaSourcing": "INAD",
    "ChinaPaying": "OL/ON",
    "ChinaImplementation": "INAD",
    "Chinaverification": "INAD/OL/ON",
