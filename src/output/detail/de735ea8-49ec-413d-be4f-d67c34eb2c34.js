export default {
  ...
  "information": {
    "name": "Laser engravement",
    "description": "Laser engravement is a local application in Oskarshamn that engraves chassis type plate for the cabs and report back engraves chassis type plate to MONA via TRATT. The database resides on Oracle servers.",
    "lifecycle": {
      "asString": "endOfLife",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "e84719dd-7c6a-4ec7-98bf-7cccc6ba23fe",
    ...
    {
      "id": "8b74ea74-a5e2-43cd-8b11-43b3074aea01",
    ...
    {
      "id": "6f1bf04e-7f51-4cbf-bef0-d9e27552d476",
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "200d03da-7508-43a7-8a4d-a31a0a1023ca",
          "displayName": "Microsoft Windows Server Standard 2008",
          "category": "software",
        ...
        {
          "id": "cf640ff8-e4b6-4de1-bbcf-dbcd3cc09728",
          "displayName": "RSlinx",
          "category": "software",
          "description": null,
          "type": "ITComponent",
  ...
  "chinaInfo": {
    ...
    "ChinaDesign": "INBB/TTPC",
    "ChinaSourcing": "INBB",
    "ChinaPaying": "INBB / TTPC",
    "ChinaImplementation": "INBB/TTPC",
    "Chinaverification": "TCHP",
