export default {
  ...
  "information": {
    "name": "Visual Studio",
    "description": ".Net development environment\n\nIs used to build and compile C# code.\nC++ code.\nIs used to run emulator and to develop WTK for windows.\n",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "62b6ed02-93c4-4e24-b0e0-105350ae341d",
    ...
    {
      "id": "a81c7301-3106-4c96-b305-a8358e86eac6",
    ...
    {
      "id": "28802129-775a-4b4a-8644-73540cfdf02b",
