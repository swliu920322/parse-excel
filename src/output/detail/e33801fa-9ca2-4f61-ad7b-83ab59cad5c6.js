export default {
  ...
  "subscriptions": [
    ...
    },
    {
      "firstName": "Guilherme",
      "lastName": "Silva",
      "displayName": "Guilherme Silva",
      "email": "guilherme.x.silva@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "IT Delivery Responsible"
      ]
  ...
  "information": {
    "name": "VDI",
    "description": "Silo part of Primus used for accessing VDI",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "2a09fcc5-be5c-4f49-8dc5-3937e337a349",
    ...
    {
      "id": "675a4359-961a-41cc-a9c1-a4a962032466",
  ...
  "businessSupport": {
    ...
    "organisations": [
      {
        "id": "05a2ecff-6f54-4d5b-8dd8-f5767817269d",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IB - Digital Workplace / IBC - Productivity Services / IBCE - Virtual Workspace",
        "usageType": "owner",
        "description": null,
        "lifecycle": {
          "asString": "active",
