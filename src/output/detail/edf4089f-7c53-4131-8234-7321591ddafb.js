export default {
  ...
  "subscriptions": [
    {
      "firstName": "Erik",
      "lastName": "Söderberg",
      "displayName": "Erik Söderberg",
      "email": "erik.x.soderberg@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    {
      "firstName": "Ganesh Babu",
      "lastName": "Jagadeesan",
      "displayName": "Ganesh Babu Jagadeesan",
      "email": "ganesh.babu.jagadeesan@scania.com",
      "type": "OBSERVER",
      "role": []
    },
    {
    ...
    {
      "firstName": "Tommy",
      "lastName": "Bodin Bjarm",
      "displayName": "Tommy Bodin Bjarm",
      "email": "tommy.bjarm@scania.com",
      "type": "RESPONSIBLE",
      "role": []
    }
  ],
  "information": {
    "name": "CWP",
    "description": "System connecting the different WMS to different picking devices.\nCurrent CWP setup “translate” the logistic pick orders from the Ebba system in Logistic DT area to pick-to-light device via Scania IOT platform.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "6c41e5fb-d819-487a-8bb8-9a332ea9b2d9",
      "displayName": "CWP (picking)",
      "fullName": "CWP (picking)",
      "tags": [],
      "lifecycle": null,
      "subscriptions": [
        {
    ...
    {
      "id": "67559bdc-9a1c-4c46-bb7a-7c9ac7b4b905",
      "displayName": "EBBA",
      "fullName": "EBBA",
      "tags": [],
      "lifecycle": null,
    ...
    {
      "id": "a8266fae-5d0d-431f-bea2-1f707c1c7a1a",
    ...
    {
      "id": "cf0e6b72-4c5b-47da-9f2c-a87eda95dd3f",
    ...
    {
      "id": "e01ddb0e-984d-4649-96cf-3520ac58b3a1",
    ...
    {
      "id": "3c5137a3-99b0-4fcc-9404-9466d0dcf16d",
  ...
  "businessSupport": {
    ...
    "processes": [
      {
        "id": "96194689-6efb-4edd-8286-c011e470daa5",
        "displayName": "China - Inhouse Line feeding Chassis",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
  ...
  "chinaInfo": {
    ...
    "ChinaDesign": "INAD/OLX",
    "ChinaSourcing": "INAD",
    "ChinaPaying": "OLX",
    "ChinaImplementation": "INAD",
    "Chinaverification": "INAD/OLX",
