export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "hannan.razzaq@scania.com",
      "email": "hannan.razzaq@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "ECE Labeling",
    "description": "Managing and printing of labels for trucks and buses that has ECE certificate. Also covers the CO2 Air Drag Component ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "c8b9d87e-ff9a-4bcc-b3e1-508d3cde5604",
    ...
    {
      "id": "6d7a787b-ca1e-4920-a1e8-13489b59c663",
    ...
    {
      "id": "8802ccce-c8c4-421b-93d7-56132ec59b59",
      "displayName": "SAS Industrial Project - China / China RnD PrIT / SAS R&D Legal",
      "fullName": "SAS R&D Legal",
      "tags": [
        "China affected"
      ],
      "lifecycle": null,
      "subscriptions": [
        ...
        {
          "displayName": "Rajeev Kalamthodi",
          "email": "rajeev.kalamthodi@scania.com",
          "type": "RESPONSIBLE"
        },
        {
          "displayName": "Marcus Gustafsson",
    ...
    {
      "id": "a4ce48bb-1fa2-41b1-b896-49e30dd79869",
  ...
  "businessSupport": {
    ...
    "organisations": [
      ...
      {
        "id": "2d852870-01bd-40b4-883b-b838ccaa43fa",
        "displayName": "Scania - Scania CV AB / P_PL - Production & Logistics / M - Chassis, Cab and Bus Production / MZ - Scania Production, Zwolle",
        "usageType": "user",
        "description": null,
        "lifecycle": {
          "asString": "active",
  ...
  "management": {
    "objects": [
      {
        "id": "c7f2b3fe-7591-4f8c-a7fa-dcd742df4d62",
        "description": "Represents each individual Type Approval Certificate.",
        "displayName": "Legal Control Domain / Type Approval & Certificate Entity / Type Approval Certificate",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "interfaceConsume": [
      {
        "id": "fe845fcc-b628-47bc-9f53-a09c1e1f310a",
        "description": null,
        "displayName": "OAS Platform / OAS_OAS_prod_typeapproval_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "d90014f6-eb63-4f2b-8b7c-0e5604b9244c",
        ...
        "displayName": "OAS Platform / OAS_OAS_production_certificateofconformity_v1 IE v1",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
