export default {
  ...
  "subscriptions": [
    {
      "firstName": "Veera",
      "lastName": "Kothuri",
      "displayName": "Veera Kothuri",
      "email": "veera.kothuri@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Fredrik",
      "lastName": "Sarlén",
      "displayName": "Fredrik Sarlén",
      "email": "fredrik.sarlen@scania.com",
      "type": "RESPONSIBLE",
      "role": [
    ...
    },
    {
      "firstName": "Åsa",
      "lastName": "Blomqvist",
      "displayName": "Åsa Blomqvist",
      "email": "asa.blomqvist@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    },
    {
      "firstName": null,
      "lastName": null,
      "displayName": "kerstin.lindmark@scania.com",
      "email": "kerstin.lindmark@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
  ...
  "information": {
    "name": "Scania Lexicon",
    "description": "The corporate Scania term database.  The application is developed on top TermWeb4 application.  TermWeb4 is provided by Interverbum Technology AB.",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "c7e31703-b168-42ed-8507-21d2a1520916",
    ...
    {
      "id": "ffefd632-039b-4131-9129-540d107bb084",
    ...
    {
      "id": "e2ca4813-bcac-4180-baad-c63b21939def",
  ...
  "businessSupport": {
    ...
    "capabilities": [
      ...
      {
        "id": "16f2522c-b97d-4dac-b704-b50108608b63",
        "displayName": "E. Solution Development & Optimization / Transport Solution Design / Service Design",
        "description": "The capability of designing all Scania services independently of their type. Eg: specifying objectives, identifying operational risks, adhering to regulations, ensuring financing of the service, business modelling of the service (eg which customer segment etc), making the process/system development and deciding ownership of the service.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "57be4445-6127-4cc1-b2d4-9fcf9b39147d",
        "displayName": "E. Solution Development & Optimization / Transport Solution Design / Tools Design",
        "description": null,
        "lifecycle": {
          "asString": "active",
          "phases": [
      ...
      {
        "id": "9626d18e-1dea-423f-819b-10850830c4a6",
        "displayName": "I. Presales, Sales and Customer Relationship Management / Brand & Market Communication / Marketing Communications Management",
        "description": "Eg:\n\nProduct & services catalouge publishing",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "0ce09cbe-d747-4c50-b638-8291c0f3efe0",
        "displayName": "L. Provide Customer Experience, Services and Continuous Optimization / Product Repair, Maintenance and Updating",
        "description": "Ability to maintain, troubleshoot, repair, rebuild or update physical products such as vehicles or engines including onboard software, and keep track of product individuals’ specifications over time.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "46617c1e-9cc3-4690-baf8-344548dcc84d",
        "displayName": "O. People and Talent Management / Health Management / Health Services",
        "description": "Eg: \n\nRunning health care",
        "lifecycle": {
          "asString": "active",
          "phases": [
    ...
    "processes": [
      ...
      {
        "id": "456b7137-cabb-4a66-afe7-54ee3024b3b2",
        "displayName": "Supporting processes / People & Culture / SHE",
        "description": null,
        "lifecycle": null,
        "subscriptions": [],
        "tags": []
