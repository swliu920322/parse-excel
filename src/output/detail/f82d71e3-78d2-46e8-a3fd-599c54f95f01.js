export default {
  ...
  "subscriptions": [
    {
      "firstName": null,
      "lastName": null,
      "displayName": "anders.cortnum@scania.com",
      "email": "anders.cortnum@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "initiatives": [
    {
      "id": "d97db9b8-2bb0-4e07-b081-74232a230032",
  ...
  "businessSupport": {
    ...
    "capabilities": [
      {
        "id": "1126017b-ec8c-4f1a-b24a-fd53aafb2d2b",
        "displayName": "O. People and Talent Management / Compensation & Benefits Management / Benefits Management",
        "description": "The ability to identifiy, define, plan, track, and realise business benefits.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "032049e2-090a-4b38-9e59-421f88bbd3b2",
        "description": null,
        "displayName": "Dayforce SGB_SGB-Connect - SML",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
  ...
  "tech": {
    "itComponents": {
      "software": [
        {
          "id": "b69e1095-760f-4f47-848b-606c97293602",
          "displayName": "Benify Benify",
          "category": "software",
          "description": "Benify provides a cloud-based compensation & benefits management; enrolment; and communication portal.",
          "type": "ITComponent",
          "lifecycle": {
            "asString": "active",
            "phases": [
