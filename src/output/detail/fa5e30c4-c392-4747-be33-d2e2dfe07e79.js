export default {
  ...
  "subscriptions": [
    {
      "firstName": "David",
      "lastName": "Schulz",
      "displayName": "David Schulz",
      "email": "david.schulz@scania.com",
      "type": "OBSERVER",
      "role": [
        "Expert User"
      ]
    },
    {
      "firstName": "Manjunath",
      "lastName": "Baswaraj",
      "displayName": "Manjunath Baswaraj",
      "email": "manjunath.baswaraj@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
  ...
  "information": {
    "name": "ExpertCAD",
    "description": "CAD Application for Tool Design (2D)",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "c1cf5d6a-a60e-499b-8e03-17cd2cfe4e42",
    ...
    {
      "id": "a968451e-1fa5-4f6f-b2b2-7f5efc099138",
