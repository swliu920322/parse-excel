export default {
  ...
  "subscriptions": [
    {
      "firstName": "Nicklas",
      "lastName": "Karlsson",
      "displayName": "Nicklas Karlsson",
      "email": "nicklas.karlsson@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Information Owner"
      ]
    ...
    },
    {
      "firstName": "Philip",
      "lastName": "Afrim",
      "displayName": "Philip Afrim",
      "email": "philip.afrim@scania.com",
      "type": "RESPONSIBLE",
      "role": [
        "Product Owner"
      ]
    ...
    },
    {
      "firstName": "Thomas",
      "lastName": "van Lit",
      "displayName": "Thomas van Lit",
      "email": "thomas.van.lit@scania.com",
      "type": "OBSERVER",
      "role": []
    }
  ],
  "information": {
    "name": "COW",
    "description": "Central Orders on the Web. \nThe cornerstones of the COW application are the COW Order Processor, the COW Web Services and the COW Order Monitor which visualises the complete chassis order process from the salesman at Dealer, via the Distributor,  to the factory and back. \n\nThe COW Order processor handles chassis order entry and order changes transmitted by Scania sales tools, confirmations and order updates transmitted by the factory and/or distributor and stores all order information & order life cycle events in the COW database. The Order Processor has interfaces towards the factory order system IACOB and the distributor order system SVAS. \n\nThe COW Web Services provide controlled access to COW order functionality and chassis order database. The Web Services are used as an interface by Scania sales tools and dealer systems in order to access the COW Order Processor and chassis order information. ",
    "lifecycle": {
      "asString": "active",
      "phases": [
        {
  ...
  "initiatives": [
    {
      "id": "6ddf603c-1a70-4b8b-b279-a61c4a2f6aa9",
  ...
  "businessSupport": {
    ...
    "processes": [
      ...
      {
        "id": "d6d49d30-0005-4501-91cf-ffa31f7ed8df",
        "displayName": "Sustainable Transport Solution / Sales / Solution Sales / Deal",
        "description": "Once customer/prospect agrees and accepts the proposed solution offering, the preparations for placing the order of the different products & services take place. ",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "f1c185d8-dea8-4a0e-9dbe-f0e68f449782",
        "displayName": "Sustainable Transport Solution / Sales / Solution Sales / Quote & Price",
        "description": "This step has the focus on verifying and adding all prices and extra costs that are part of the offering to be presented to the future buyer. Verification of delivery capacity is also part of this step.",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
    ...
    "organisations": [
      {
        "id": "044cfec1-38f8-4a6f-9a6d-69c49ef6f433",
        "displayName": "Scania - Scania CV AB / I - Scania IT / IA - Sales & Services IT / IAS - Sales IT",
  ...
  "management": {
    ...
    "interfaceConsume": [
      {
        "id": "3be7ebc6-7f7f-40ff-9d88-6099a0c4c41f",
        "description": "This interface provides Vehicle Data.",
        "displayName": "FMP_Vehicle Information Service",
        "lifecycle": null,
        "tags": []
      },
      {
      ...
      {
        "id": "e467a889-b58c-44f9-a14d-b198637055a7",
        "description": null,
        "displayName": "PRAL_Calendar_Info",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "6e206822-2ee9-4df9-aa11-e7cf3f487ee8",
        "description": null,
      ...
      {
        "id": "31db1c8f-4d71-4d73-8638-e8c3d23dec75",
        "description": null,
        "displayName": "Scania Configurator_SECM",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "9c35831e-972a-45f0-b932-095c7dc5dd4c",
        "description": "COW sends Order Changes and Registrations to SVAS. SVAS sends back Specification, Chassis, Cost and Order dates to be displayed in COW - Communications made via SIAMIP/Broker. (Scania Information Access Method)\n",
        "displayName": "SVAS SGB_COW",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
      ...
      {
        "id": "984962b8-55b7-4986-8c6b-6ddb32d9a167",
        "description": null,
        "displayName": "WAM_COW - https://cow.scania.com",
        "lifecycle": null,
        "tags": [
          "XDS_RP"
        ]
      ...
      {
        "id": "1c6c7639-ee67-4ea2-9313-8c9e81f963f0",
        "description": null,
        "displayName": "WAM_COW - https://cowap.scania.com",
        "lifecycle": null,
        "tags": [
          "XDS_RP"
        ]
      ...
      {
        "id": "0376a84b-4f75-4f71-8192-dc0c629b55bd",
        "description": null,
        "displayName": "WAM_SPII - https://spiiapi.scania.com",
        "lifecycle": null,
        "tags": [
          "Public_RP"
        ]
    ...
    "interfaceProvide": [
      {
        "id": "ba222ec1-9fc1-484d-a50a-c38a0691e58d",
        "description": null,
        "displayName": "COW_Sales order [ODBC SQL]",
        "lifecycle": null,
        "tags": []
      },
      {
        "id": "31d8d0da-1563-4c90-9109-e1dc31ec5c2f",
        "description": "COW sends Order Changes and Registrations to SVAS. SVAS sends back Specification, Chassis, Cost and Order dates to be displayed in COW - Communications made via SIAMIP/Broker. (Scania Information Access Method) \n\nThe interface between SVAS and COW is receiving and sending.  SVAS receives Order Registrations and Changes from COW again via a flat file with a predefined layout. SVAS forwards any files received from IACOB to COW again via a predefined flat file. The protocol is again QSNADS between the SGB400 IBMi and the central server SSS400 File receipt is also controlled via job CESOWPRT, the sending by SGB_OSA\n",
        "displayName": "COW_SVAS SGB",
        "lifecycle": {
          "asString": "active",
          "phases": [
            {
